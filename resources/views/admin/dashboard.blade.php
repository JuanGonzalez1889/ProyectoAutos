...
@section('page-title', 'Resumen Global')
            ...
            <div class="card">
                ...
                <div class="border border-[hsl(var(--border))] rounded-lg p-5 mb-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="{{ route('admin.users.create') }}" class="text-xs text-[hsl(var(--primary))] hover:underline">Acceso Admin</a>
                    </div>
                                ...
                                <tr class="border-b border-[hsl(var(--border))] hover:bg-[hsl(var(--muted))]/50">
                                    ...
                                    <td class="py-3">
                                        <span class="px-2 py-0.5 text-xs font-medium rounded
                                            @if($user->roles->first()?->name === 'AGENCIERO') bg-yellow-500/20 text-yellow-600
                                            @elseif($user->roles->first()?->name === 'ADMIN') bg-purple-500/20 text-purple-600
                                    ...
                                    <td class="py-3">
                                        <span class="px-2 py-0.5 text-xs font-medium rounded
                                            @if($user->is_active) bg-green-500/20 text-green-600
