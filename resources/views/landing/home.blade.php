...
@section('seo')
    <x-seo title="AutoWeb Pro - Tu concesionaria online en minutos"
        description="Plataforma SaaS todo-en-uno para agencias de autos. Gestiona inventario, leads, sitio web personalizado y más."
...
@section('content')
    ...
    <nav class="w-full px-6 py-4 flex items-center justify-between bg-slate-950 shadow-md md:px-12">
        ...
        <!-- Hamburguesa -->
        <button id="menuBtn"
            class="md:hidden flex items-center justify-center w-10 h-10 rounded bg-slate-900 hover:bg-slate-800 transition">
        ...
        <!-- Panel lateral -->
        <div id="mobileMenu"
            class="fixed inset-0 z-50 bg-slate-950 bg-opacity-95 flex flex-col items-center justify-center gap-8 text-white text-lg transition-transform transform translate-x-full md:hidden">
            ...
            <a href="{{ route('register') }}"
                class="btn-gradient px-6 py-2 rounded-lg font-semibold text-white">Comenzar</a>
        </div>
    </nav>
    <script>
    ...
    <!-- Hero Section -->
    <section
        class="relative min-h-screen flex flex-col md:flex-row items-center justify-center w-full px-4 md:px-[10rem] md:overflow-x-hidden">
        <div class="w-full flex flex-col md:flex-row gap-12 items-center justify-center mx-auto">
            ...
            <div class="text-center md:text-left w-full md:w-1/2 flex flex-col justify-center px-0 md:px-0">
                ...
                <p class="text-base md:text-xl text-gray-400 mb-8 leading-relaxed">
                    La plataforma todo-en-uno para gestionar tu inventario, conectar con clientes y vender más autos sin
                    complicaciones técnicas ni código.
                </p>
                <!-- CTA Buttons -->
                <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    <a href="{{ route('register') }}"
                        class="px-8 py-4 btn-gradient rounded-lg font-semibold text-white hover:opacity-90 inline-flex items-center justify-center gap-2">
                        Comenzar hoy
                    ...
                    <a href="{{ route('landing.demo-instructivos') }}" class="px-8 py-4 glass rounded-lg font-semibold text-white hover-glow inline-flex items-center justify-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex-1 space-y-4">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <div class="bg-green-500/10 border border-green-500/20 rounded-lg p-3">
                                    <div class="h-3 w-16 bg-green-500/30 rounded mb-2"style="width: 3rem"></div>
                                    <div class="h-6 w-12 bg-white/20 rounded"></div>
                                </div>
                                <div class="bg-purple-500/10 border border-purple-500/20 rounded-lg p-3">
                                    <div class="h-3 w-16 bg-purple-500/30 rounded mb-2"style="width: 3rem"></div>
                                    <div class="h-6 w-12 bg-white/20 rounded"></div>
                                </div>
    ...
    <section class="bg-[#020617] py-24 w-full px-4 md:px-12 text-white overflow-x-hidden">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16 w-full">
                <div
                    class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 text-xs font-semibold uppercase tracking-wider text-blue-400 mb-4">
                ...
                <h2 class="text-4xl md:text-5xl font-bold mb-4">
                    ...
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">digital en
                        minutos.</span>
                </h2>
                <p class="text-slate-400 max-w-3xl mx-auto text-lg">
                    Desde el registro hasta la publicación, simplificamos cada paso con nuestra tecnología automatizada.
                    Diseño premium y gestión de stock integrada en una plataforma unificada.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-16 items-start w-full">
                ...
                <div class="space-y-8 w-full">
                    ...
                    <div class="relative pl-10">
                        <!-- Timeline Line -->
                        <div class="absolute left-3 top-8 bottom-0 w-0.5 bg-gradient-to-b from-blue-500 to-transparent">
                        </div>

                        <!-- Number Circle -->
                        <div
                            class="absolute left-0 top-0 w-6 h-6 rounded-full bg-blue-500 flex items-center justify-center shadow-[0_0_20px_rgba(59,130,246,0.6)]">
                    ...
                    <div class="relative pl-10">
                        ...
                        <p class="text-slate-400 text-sm leading-relaxed">
                            Gestioná todo desde un dashboard intuitivo: stock, leads, estadísticas y configuración en un
                            solo lugar.
                        </p>
                    </div>
                </div>
            ...
            <div class="text-center mt-16">
                <p class="text-slate-400 mb-6">
                    Desde el registro hasta la publicación: <span class="text-white font-semibold">menos de 15
                        minutos</span>
                </p>
                <a href="{{ route('register') }}"
                    class="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-700 rounded-lg font-semibold text-white shadow-[0_0_25px_rgba(37,99,235,0.4)] hover:shadow-[0_0_35px_rgba(37,99,235,0.6)] transition-all">
                    Comenzar Ahora
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
            ...
            <div class="absolute inset-0 pointer-events-none">
                <!-- Gradient Orbs -->
                <div
                    class="absolute top-1/2 left-1/4 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl">
                </div>
                <div
                    class="absolute top-1/2 right-1/4 translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl hidden md:block">
                </div>
            </div>
            ...
            <div class="max-w-7xl mx-auto px-4 relative mt-16 w-full">
                ...
                <div class="flex items-center justify-center gap-4 w-full">
                    ...
                    <div class="flex items-center gap-4">
                        <div
                            class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-xl border border-white/10 flex items-center justify-center rotate-45">
                        ...
                        <div
                            class="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500/20 to-blue-500/20 backdrop-blur-xl border border-white/10 flex items-center justify-center -rotate-12">
    ...
    <section id="servicios" class="bg-[#020617] py-24 w-full overflow-x-hidden">
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            <div class="text-center mb-24">
                ...
                <p class="text-lg text-slate-400 max-w-3xl mx-auto">
                    Potencia cada aspecto de tu negocio con herramientas diseñadas específicamente para la industria
                    automotriz moderna.
                </p>
            </div>
            <!-- Scroll Indicator -->
        ...
        <div
            ...
            <div class="w-full md:w-1/2">
                ...
                <p class="text-slate-400 text-lg leading-relaxed mb-6">
                    Una concesionaria online profesional lista en minutos. Diseño moderno, responsive y optimizado para
                    convertir visitantes en clientes. Totalmente personalizable sin necesidad de código.
                </p>
            ...
            <div class="w-full md:w-1/2">
                <div
                    class="bg-slate-900/80 border border-slate-800 rounded-2xl shadow-2xl shadow-blue-500/5 overflow-hidden flex items-center justify-center">
                    <img src="/storage/web.jpeg" alt="Sitio Web Personalizado"
        ...
        <div
            ...
            <div class="w-full md:w-1/2">
                ...
                <p class="text-slate-400 text-lg leading-relaxed mb-6">
                    Controla todo desde un solo lugar. Panel intuitivo con permisos personalizables para cada vendedor,
                    gerente o administrador. Auditoría completa de actividades.
                </p>
                <ul class="space-y-3 mb-6">
                    <li class="flex items-start gap-3 text-slate-300">
                        <svg class="w-5 h-5 text-blue-500 mt-0.5" fill="none" stroke="currentColor"
                ...
                <a href="login" class="text-blue-400 font-semibold hover:text-blue-300 transition-colors">Explorar panel
                    →</a>
            </div>
            <div class="w-full md:w-1/2">
                <div
                    class="bg-slate-900/80 border border-slate-800 rounded-2xl shadow-2xl shadow-blue-500/5 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div
                                class="h-9 px-3 rounded-lg bg-emerald-500/20 text-emerald-300 text-xs font-semibold border border-emerald-500/30 flex items-center">
                                + Crear Usuario</div>
                        </div>

                        <!-- Stats Cards -->
                        <div class="grid gap-3 mb-4 sm:grid-cols-4 grid-cols-1">
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            <div
                                class="flex-1 flex items-center gap-2 bg-slate-800/50 border border-slate-700/50 rounded-lg px-3 py-2">
                            ...
                            <div
                                class="h-9 px-3 rounded-lg border border-slate-700 flex items-center gap-2 text-xs text-slate-300">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <!-- Table Header -->
                        <div
                            class="grid grid-cols-4 gap-4 sm:grid-cols-6 sm:gap-4 text-[10px] uppercase tracking-wider text-slate-500 font-semibold mb-3 user-table-header">
                            <div class="break-words whitespace-normal">Usuario</div>
                            <div class="break-words whitespace-normal">Email</div>
                            <div class="break-words whitespace-normal">Agencia</div>
                            <div class="break-words whitespace-normal">Estado</div>
                            <div class="hidden sm:block break-words whitespace-normal">Registro</div>
                        </div>

                        <!-- Table Rows -->
                        <div class="space-y-2">
                            <div
                                class="grid grid-cols-4 gap-4 sm:grid-cols-6 sm:gap-4 items-center bg-slate-800/30 rounded-lg px-4 py-2 text-sm user-table-row">
                                <div class="break-words whitespace-normal flex items-center gap-2">
                                    <span class="text-white font-semibold">Juan</span>
                                </div>
                                <div class="break-words whitespace-normal text-slate-400 text-xs">piru1889@...</div>
                                <div class="break-words whitespace-normal text-blue-400 text-xs">Agencia de Mauro</div>
                                <div class="break-words whitespace-normal text-emerald-400 text-[10px] font-semibold">
                                    Activo</div>
                                <div class="break-words whitespace-normal text-slate-400 text-xs hidden sm:block">
                                    06/01/2026</div>
                            </div>
                            <div
                                class="grid grid-cols-4 gap-2 sm:grid-cols-6 sm:gap-4 items-center bg-slate-800/30 rounded-lg px-4 py-2 text-sm user-table-row">
                                <div class="flex items-center gap-2">
                                    <span class="text-white font-semibold">Mauro</span>
                                </div>
                                <div class="break-words whitespace-normal text-slate-400 text-xs">mauro@...</div>
                                <div class="break-words whitespace-normal text-blue-400 text-xs">Agencia de Mauro</div>
                                <div class="break-words whitespace-normal text-emerald-400 text-[10px] font-semibold">
                                    Activo</div>
                                <div class="break-words whitespace-normal text-slate-400 text-xs hidden sm:block">
        ...
        <div
            ...
            <div class="w-full md:w-1/2">
                ...
                <p class="text-slate-400 text-lg leading-relaxed mb-6">
                    Gestiona tu inventario completo con actualizaciones en tiempo real. Registra vehículos, detalles
                    técnicos, galerías fotográficas y sincroniza automáticamente con todas tus plataformas.
                </p>
                <ul class="space-y-3 mb-6">
                    <li class="flex items-start gap-3 text-slate-300">
                        <svg class="w-5 h-5 text-blue-500 mt-0.5" fill="none" stroke="currentColor"
                ...
                <a href="login" class="text-blue-400 font-semibold hover:text-blue-300 transition-colors">Más sobre
                    stock →</a>
            </div>
            <div class="w-full md:w-1/2">
                <div
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between bg-slate-800/50 rounded-lg px-4 py-3">
                                ...
                                <span
                                    class="text-[10px] px-2 py-1 rounded-full bg-blue-500/20 text-blue-300 border border-blue-500/30">Activo</span>
                            </div>
                            <div class="flex items-center justify-between bg-slate-800/50 rounded-lg px-4 py-3">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-lg bg-slate-700/60"></div>
                                ...
                                <span
                                    class="text-[10px] px-2 py-1 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30">Reservado</span>
                            </div>
                            <div class="flex items-center justify-between bg-slate-800/50 rounded-lg px-4 py-3">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-lg bg-slate-700/60"></div>
                                ...
                                <span
                                    class="text-[10px] px-2 py-1 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">Vendido</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div
            ...
            <div class="w-full md:w-1/2">
                ...
                <p class="text-slate-400 text-lg leading-relaxed mb-6">
                    Hosting de clase mundial incluido en tu plan. Tu sitio se carga en milisegundos con CDN global,
                    certificados SSL automáticos y máxima seguridad. Dominio personalizado configurado en minutos.
                </p>
                <ul class="space-y-3 mb-6">
                    <li class="flex items-start gap-3 text-slate-300">
                        <svg class="w-5 h-5 text-blue-500 mt-0.5" fill="none" stroke="currentColor"
                ...
                <a href="login" class="text-blue-400 font-semibold hover:text-blue-300 transition-colors">Conocé la
                    infraestructura →</a>
            </div>
            <div class="w-full md:w-1/2">
                <div
                    class="bg-slate-900/80 border border-slate-800 rounded-2xl shadow-2xl shadow-blue-500/5 overflow-hidden flex flex-col items-center justify-center py-8">
                    <div class="relative w-56 h-56 mx-auto flex items-center justify-center">
                        <!-- SVG con dos anillos animados -->
                        <svg class="absolute inset-0 w-full h-full" viewBox="0 0 220 220" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <defs>
                                <linearGradient id="blueRing" x1="0" y1="0" x2="220"
                                    y2="220" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#3b82f6" />
                                    <stop offset="1" stop-color="#06b6d4" />
                                </linearGradient>
                                <linearGradient id="greenRing" x1="220" y1="0" x2="0"
                                    y2="220" gradientUnits="userSpaceOnUse">
                            ...
                            <g>
                                <circle cx="110" cy="110" r="100" stroke="url(#blueRing)" stroke-width="8"
                                    fill="none" stroke-linecap="round" stroke-dasharray="440 220"
                                    class="animate-spin-slow-reverse" />
                                <circle cx="110" cy="110" r="90" stroke="url(#greenRing)" stroke-width="6"
                                    fill="none" stroke-linecap="round" stroke-dasharray="320 180"
                        ...
                        <div class="absolute inset-0 flex flex-col items-center justify-center">
                            ...
                            <div class="text-base uppercase tracking-widest text-blue-400 font-semibold mt-1">Performance
                            </div>
                        </div>
                    </div>
        ...
        <div
            ...
            <div class="w-full md:w-1/2">
                ...
                <p class="text-slate-400 text-lg leading-relaxed mb-6">
                    Datos en tiempo real para tomar decisiones más inteligentes. Dashboards intuitivos con métricas de
                    ventas, ingresos, y leads.
                </p>
                <ul class="space-y-3 mb-6">
                    <li class="flex items-start gap-3 text-slate-300">
                        <svg class="w-5 h-5 text-blue-500 mt-0.5" fill="none" stroke="currentColor"
                ...
                <a href="login" class="text-blue-400 font-semibold hover:text-blue-300 transition-colors">Explorar
                    reportes →</a>
            </div>
            <div class="w-full md:w-1/2">
                <div
                    ...
                    <div class="p-6" style="min-height:260px;display:flex;align-items:center;justify-content:center;">
                        <div
                            style="width:100%;max-width:520px;min-width:320px;min-height:220px;position:relative;border:2px dashed #3b82f6; border-radius:12px; background:rgba(30,41,59,0.7);padding:12px;">
                            <canvas id="ventasChart" width="480" height="180"
                                style="display:block;width:100%;max-width:480px;"></canvas>
                        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6 py-10 w-full">
            ...
            <div class="flex justify-center mt-3">
                <svg class="w-5 h-5 text-blue-400 animate-bounce" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
    ...
    <section class="bg-[#020617] py-24 w-full overflow-x-hidden">
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            <div class="text-center mb-16">
                ...
                <p class="text-lg text-slate-400 max-w-3xl mx-auto">Además de nuestra plataforma SaaS, brindamos soluciones
                    de marketing digital para potenciar tu concesionaria.</p>
            </div>
            <div
                class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 px-4 md:px-6 py-12 rounded-3xl border border-blue-500/20 bg-gradient-to-br from-blue-900/20 to-transparent backdrop-blur-sm shadow-[0_0_40px_rgba(59,130,246,0.08)] w-full">
                <div class="w-full md:w-1/2">
                    <div class="inline-flex items-center gap-2 text-blue-400 text-xs uppercase tracking-widest mb-3">
                        <span class="w-2 h-2 rounded-full bg-blue-500"></span>
                        Marketing Digital
                    ...
                    <a href="https://wa.me/5493413365206" target="_blank" rel="noopener"
                ...
                <div class="w-full md:w-1/2 flex items-center justify-center">
                    <svg width="320" height="220" viewBox="0 0 320 220" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <rect x="10" y="10" width="300" height="200" rx="32"
                            fill="url(#bgGradientMarketing)" stroke="#1e293b" stroke-width="2" />
                        <ellipse cx="160" cy="80" rx="48" ry="32" fill="#1e293b"
                            fill-opacity="0.7" />
                        <circle cx="160" cy="80" r="24" fill="#2563eb" fill-opacity="0.8" />
                        <circle cx="160" cy="80" r="12" fill="#60a5fa" fill-opacity="0.8" />
                        <rect x="80" y="140" width="48" height="24" rx="10" fill="#2563eb"
                            fill-opacity="0.7" />
                        <rect x="192" y="140" width="48" height="24" rx="10" fill="#2563eb"
                            fill-opacity="0.7" />
                        <circle cx="104" cy="152" r="6" fill="#60a5fa" />
                        <circle cx="216" cy="152" r="6" fill="#60a5fa" />
                        <text x="160" y="200" text-anchor="middle" font-size="18" fill="#60a5fa"
                            font-family="sans-serif">Marketing Digital</text>
                        <defs>
                            <linearGradient id="bgGradientMarketing" x1="10" y1="10" x2="310"
                                y2="210" gradientUnits="userSpaceOnUse">
    ...
    {{-- <section class="py-24 px-4 bg-gradient-to-b from-blue-500/5 to-transparent w-full overflow-x-hidden">
    <div class="max-w-7xl mx-auto w-full">
        ...
        <div class="relative glass rounded-2xl p-8 max-w-4xl mx-auto w-full">
            <!-- Browser Chrome -->
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16">
                ...
                <p class="text-lg text-gray-400 max-w-3xl mx-auto">
                    Contanos tu idea o desafío y te ayudamos a transformarlo en una solución tecnológica real para tu
                    agencia.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="https://wa.me/5493413365206"
                                    class="text-lg text-white hover:text-blue-400 transition-colors font-semibold">Consultar
                                    directo</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
                    <form action="{{ route('landing.contact') }}" method="POST" class="space-y-6">
                        ...
                        <!-- Message -->
                        <div>
                            <textarea name="message" rows="6" placeholder="Contanos sobre tu proyecto"
