...
@section('title', 'Próximamente - AutoWeb Pro')

@section('content')
<x-navbar cta-label="Notificarme" cta-link="#notificarme" cta-class="bg-white/10 hover:bg-white/20 border border-white/10 text-white" />
...
<section id="notificarme" class="pb-20 px-4">
    <div class="max-w-3xl mx-auto text-center">
        ...
        <form action="{{ route('landing.newsletter') }}" method="POST" class="flex flex-col sm:flex-row gap-3 justify-center">
            @csrf
