...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-[hsl(var(--foreground))]">Editar Lead: {{ $lead->name }}</h1>
    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="source" 
                            ...
                            <option value="web" {{ old('source', $lead->source) === 'web' ? 'selected' : '' }}>Sitio Web</option>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="status" 
                            ...
                            <option value="interested" {{ old('status', $lead->status) === 'interested' ? 'selected' : '' }}>Interesado</option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="datetime-local" 
                               name="next_follow_up" 
                               id="next_follow_up"
                               value="{{ old('next_follow_up', $lead->next_follow_up?->format('Y-m-d\TH:i')) }}"
                               class="w-full px-3 py-2 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))] focus:outline-none focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-transparent">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" 
                                  id="notes"
                                  rows="4"
                                  class="w-full px-3 py-2 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))] focus:outline-none focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-transparent resize-none">{{ old('notes', $lead->notes) }}</textarea>
                        @error('notes')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
