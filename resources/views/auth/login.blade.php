    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center bg-[hsl(var(--background))] p-8">
        <div class="w-full max-w-md space-y-6">
            ...
            <div class="pt-4 border-t border-[hsl(var(--border))]">
                ...
                <a href="{{ route('register') }}" class="w-full block px-4 py-3 bg-[#1a1f26] border border-[hsl(var(--primary))] text-[hsl(var(--primary))] font-medium rounded-lg hover:bg-[hsl(var(--primary))]/10 transition-colors text-center">
                    + Registra tu Agencia
                </a>
            </div>
