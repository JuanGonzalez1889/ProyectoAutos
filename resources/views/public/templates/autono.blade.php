            ...
            @forelse($vehicles->take(8) as $vehicle)
                <article class="vehicle-card">
                    <a href="{{ route('public.vehiculos.show', $vehicle->id) }}" class="block">
                        <img src="{{ $vehicle->main_image }}" alt="{{ $vehicle->title }}" class="w-full h-52 object-cover hover:scale-105 transition duration-500">
                    </a>
                    <div class="p-4">
