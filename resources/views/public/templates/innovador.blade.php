        ...
        <div class="relative rounded-3xl overflow-hidden min-h-[300px]">
            @if(isset($editMode) && $editMode)
                <div class="editable-section w-full h-full absolute inset-0">
                    ...
                    @else
                        <div class="w-full min-h-[300px]" style="background: linear-gradient(135deg, #1e293b, #334155);"></div>
                    @endif
            ...
            @else
                ...
                @else
                    <div class="w-full min-h-[300px] absolute inset-0" style="background: linear-gradient(135deg, #1e293b, #334155);"></div>
                @endif
            @endif
