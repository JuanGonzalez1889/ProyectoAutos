        ...
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between relative">
            ...
            <div class="hidden md:flex items-center gap-8">
                <a href="#inicio" class="text-sm font-medium transition hover:text-white"
                    style="color: {{ $settings->navbar_links_color ?? 'rgba(255,255,255,0.6)' }}">Inicio</a>

                <a href="{{ route('public.vehiculos') }}" class="text-sm font-medium transition hover:text-white"
                    style="color: {{ $settings->navbar_links_color ?? 'rgba(255,255,255,0.6)' }}">Vehículos</a>
                <a href="#nosotros" class="text-sm font-medium transition hover:text-white"
                    style="color: {{ $settings->navbar_links_color ?? 'rgba(255,255,255,0.6)' }}">Nosotros</a>
                <a href="#contacto" class="text-sm font-medium transition hover:text-white"
                    style="color: {{ $settings->navbar_links_color ?? 'rgba(255,255,255,0.6)' }}">Contacto</a>
            </div>
                ...
                @if (isset($editMode) && $editMode)
                    <div class="editable-section mb-8">
                        <p class="text-lg text-white/60 leading-relaxed max-w-lg"
                            style="color: {{ $settings->home_description_color ?? 'rgba(255,255,255,0.6)' }}">
                ...
                @if (isset($editMode) && $editMode)
                    <div class="editable-section rounded-2xl overflow-hidden">
                        @if ($settings && $settings->banner_url)
                            <img src="{{ $settings->banner_url }}" alt="Banner"
                    ...
                    @if (isset($editMode) && $editMode)
                        <div class="editable-section mb-6">
                            <p class="text-base text-white/60 leading-relaxed whitespace-pre-line"
                                style="color: {{ $settings->nosotros_description_color ?? 'rgba(255,255,255,0.6)' }}">
                    ...
                    @if (isset($editMode) && $editMode)
                        <div class="editable-section flex gap-8">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-white/40 mt-0.5">{{ $settings->stat2_label ?? 'Satisfacción' }}
                                </p>
                            </div>
                            <div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-2 gap-10 mb-12">
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <p class="text-sm text-white/35 leading-relaxed mb-5">
                        {{ $settings->contact_message ?? 'La solución para tu próximo vehículo' }}
                    </p>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li><a href="#nosotros" class="text-white/35 hover:text-white transition">Sobre Nosotros</a>
                          ...
                          <li><a href="{{ route('public.vehiculos') }}" class="text-white/35 hover:text-white transition">Vehículos</a>
                        </li>
