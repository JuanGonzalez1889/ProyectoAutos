    ...
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="md:w-1/2 flex flex-col">
            ...
            <div class="flex gap-4 mb-2">
                <span class="text-black text-xs px-3 py-1 rounded" style="background: var(--tertiary-color);">Año: {{ $vehicle->year }}</span>
                <span class="text-black text-xs px-3 py-1 rounded" style="background: var(--tertiary-color);">Precio: ${{ number_format($vehicle->price) }}</span>
            </div>
