...
<?php $__env->startSection('title', 'Configuración Avanzada de Agencia'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-[hsl(var(--background))] to-[hsl(var(--secondary))]">
    <div class="max-w-6xl mx-auto px-4 py-12">
        ...
        <form action="<?php echo e(route('admin.agencia.advanced-settings.update')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-lg p-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayKey => $dayName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <label class="block text-sm font-medium text-[hsl(var(--foreground))] mb-2"><?php echo e($dayName); ?></label>
                            <div class="flex gap-2 items-center">
                                <input type="time" 
                                    name="business_hours[<?php echo e($dayKey); ?>][open]" 
                                    value="<?php echo e($businessHours[$dayKey]['open'] ?? '09:00'); ?>"
                                ...
                                <input type="time" 
                                    name="business_hours[<?php echo e($dayKey); ?>][close]" 
                                    value="<?php echo e($businessHours[$dayKey]['close'] ?? '18:00'); ?>"
                                    class="flex-1 px-3 py-2 bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))]"
                                    placeholder="Cierre">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" 
                                        name="business_hours[<?php echo e($dayKey); ?>][closed]"
                                        <?php echo e(($businessHours[$dayKey]['closed'] ?? false) ? 'checked' : ''); ?>
            ...
            <div class="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-lg p-6">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <?php $__currentLoopData = $networks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $networkKey => $networkName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <label class="block text-sm font-medium text-[hsl(var(--foreground))] mb-2"><?php echo e($networkName); ?></label>
                            <input type="url" 
                                name="social_media[<?php echo e($networkKey); ?>]" 
                                value="<?php echo e($socialMedia[$networkKey] ?? ''); ?>"
                                placeholder="https://<?php echo e(strtolower($networkName)); ?>.com/..."
            ...
            <div class="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-lg p-6">
                ...
                <div class="space-y-3">
                    <?php $__currentLoopData = $methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $methodKey => $methodName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center gap-3 p-3 border border-[hsl(var(--border))] rounded-lg cursor-pointer hover:bg-[hsl(var(--secondary))] transition">
                            <input type="checkbox" 
                                name="payment_methods[<?php echo e($methodKey); ?>]"
                                value="1"
                                <?php echo e(($paymentMethods[$methodKey] ?? false) ? 'checked' : ''); ?>

                                class="w-4 h-4 rounded text-[hsl(var(--primary))]">
                            <span class="text-[hsl(var(--foreground))]"><?php echo e($methodName); ?></span>
                        </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="mt-6 pt-6 border-t border-[hsl(var(--border))]">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="tel" 
                                name="whatsapp" 
                                value="<?php echo e($tenant->whatsapp ?? ''); ?>"
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" 
                            ...
                            value="<?php echo e($tenant->commission_percentage ?? 0); ?>"
                            min="0" 
                            max="100" 
                            step="0.01"
                            class="w-full px-3 py-2 bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))]">
                    ...
                    <div>
                        ...
                        <select name="commission_currency" class="w-full px-3 py-2 bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))]">
                            <option value="USD" <?php echo e($tenant->commission_currency === 'USD' ? 'selected' : ''); ?>>USD</option>
                            <option value="ARS" <?php echo e($tenant->commission_currency === 'ARS' ? 'selected' : ''); ?>>ARS</option>
                            <option value="MXN" <?php echo e($tenant->commission_currency === 'MXN' ? 'selected' : ''); ?>>MXN</option>
                            <option value="COP" <?php echo e($tenant->commission_currency === 'COP' ? 'selected' : ''); ?>>COP</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="business_type" class="w-full px-3 py-2 bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))]">
                            ...
                            <option value="sole_proprietor" <?php echo e($tenant->business_type === 'sole_proprietor' ? 'selected' : ''); ?>>Persona Física</option>
                            <option value="llc" <?php echo e($tenant->business_type === 'llc' ? 'selected' : ''); ?>>Sociedad de Responsabilidad Limitada</option>
                            <option value="corporation" <?php echo e($tenant->business_type === 'corporation' ? 'selected' : ''); ?>>Sociedad Anónima</option>
                            <option value="partnership" <?php echo e($tenant->business_type === 'partnership' ? 'selected' : ''); ?>>Asociación</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <input type="text" 
                            name="tax_id" 
                            value="<?php echo e($tenant->tax_id ?? ''); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" 
                            ...
                            value="<?php echo e($tenant->business_registration ?? ''); ?>"
                            class="w-full px-3 py-2 bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))]">
                    </div>
                    <div>
                        ...
                        <input type="text" 
                            ...
                            value="<?php echo e($tenant->billing_address ?? ''); ?>"
                            class="w-full px-3 py-2 bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))]">
                    </div>
                </div>
            ...
            <div class="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-lg p-6">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" 
                            name="bank_name" 
                            value="<?php echo e($tenant->bank_name ?? ''); ?>"
                            class="w-full px-3 py-2 bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))]">
                    </div>
                    <div>
                        ...
                        <input type="text" 
                            ...
                            value="<?php echo e($tenant->bank_account_holder ?? ''); ?>"
                            class="w-full px-3 py-2 bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))]">
                    </div>
                    <div>
                        ...
                        <input type="text" 
                            name="bank_account" 
                            value="<?php echo e($tenant->bank_account ?? ''); ?>"
                            class="w-full px-3 py-2 bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))]">
                    </div>
                    <div>
                        ...
                        <input type="text" 
                            ...
                            value="<?php echo e($tenant->bank_routing_number ?? ''); ?>"
                            class="w-full px-3 py-2 bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))]">
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    <label class="flex items-center gap-3 p-3 border border-[hsl(var(--border))] rounded-lg cursor-pointer hover:bg-[hsl(var(--secondary))] transition">
                        <input type="checkbox" 
                            ...
                            value="1"
                            <?php echo e($tenant->auto_approve_leads ? 'checked' : ''); ?>
                    ...
                    <div>
                        ...
                        <input type="number" 
                            ...
                            value="<?php echo e($tenant->response_time_hours ?? 24); ?>"
                            min="1" 
                            max="168"
                            class="w-full px-3 py-2 bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))]">
            ...
            <div class="flex gap-4">
                ...
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="px-8 py-3 bg-[hsl(var(--secondary))] hover:opacity-90 text-[hsl(var(--foreground))] rounded-lg font-semibold transition border border-[hsl(var(--border))]">
                    Cancelar
                </a>
            </div>
        </form>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\admin\agencia\advanced-settings.blade.php ENDPATH**/ ?>