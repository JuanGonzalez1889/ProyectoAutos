...
<head>
    ...
    <title><?php echo e($tenant->name ?? 'Agencia de Autos'); ?> - Profesional</title>
    ...
    <style>
        :root {
            --primary-color: <?php echo e($settings && $settings->primary_color ? $settings->primary_color : '#1e3a5f'); ?>;
            --secondary-color: <?php echo e($settings && $settings->secondary_color ? $settings->secondary_color : '#f8fafc'); ?>;
            --tertiary-color: <?php echo e($settings && $settings->tertiary_color ? $settings->tertiary_color : '#e2e8f0'); ?>;
        }
        body { font-family: <?php echo e($settings->font_family ?? "'Inter', sans-serif"); ?>; }
        ...
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            <div class="flex items-center gap-6">
                <?php if($settings->phone): ?>
                    <a href="tel:<?php echo e($settings->phone); ?>" class="flex items-center gap-1.5 hover:text-white transition">
                ...
                <?php if($settings->email): ?>
                    <a href="mailto:<?php echo e($settings->email); ?>" class="flex items-center gap-1.5 hover:text-white transition">
            ...
            <div class="flex items-center gap-4">
                <?php if($settings->instagram_url): ?><a href="<?php echo e($settings->instagram_url); ?>" target="_blank" class="hover:text-white transition">Instagram</a><?php endif; ?>
                <?php if($settings->facebook_url): ?><a href="<?php echo e($settings->facebook_url); ?>" target="_blank" class="hover:text-white transition">Facebook</a><?php endif; ?>
                <?php if($settings->linkedin_url): ?><a href="<?php echo e($settings->linkedin_url); ?>" target="_blank" class="hover:text-white transition">LinkedIn</a><?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <nav class="sticky top-0 z-50" style="background: var(--secondary-color); box-shadow: 0 2px 8px rgba(0,0,0,0.04); border-bottom: 1px solid var(--tertiary-color);">
        <div class="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between relative">
            <div class="flex items-center gap-3">
                <?php if(isset($editMode) && $editMode): ?>
                    <div class="editable-section inline-block relative">
                        ...
                        <?php else: ?>
                            <div class="h-10 w-10 rounded-lg flex items-center justify-center" style="background: var(--primary-color);">
                                <span class="text-white font-bold text-lg"><?php echo e(substr($tenant->name, 0, 1)); ?></span>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="editable-section inline-block relative" style="min-width:100px; display:flex; align-items:center; gap:6px;">
                        <span class="text-lg font-semibold" style="color: var(--primary-color);"><?php echo e($tenant->name); ?></span>
            ...
            <div class="hidden md:flex items-center gap-8">
                <a href="#inicio" class="text-sm font-medium text-gray-500 hover:text-gray-900 transition" style="color: <?php echo e($settings->navbar_links_color ?? '#64748b'); ?>">Inicio</a>
                <a href="<?php echo e(route('public.vehiculos')); ?>" class="text-sm font-medium text-gray-500 hover:text-gray-900 transition" style="color: <?php echo e($settings->navbar_links_color ?? '#64748b'); ?>">Inventario</a>
                <a href="#nosotros" class="text-sm font-medium text-gray-500 hover:text-gray-900 transition" style="color: <?php echo e($settings->navbar_links_color ?? '#64748b'); ?>">Empresa</a>
        ...
        <div class="relative z-10 text-center max-w-3xl mx-auto px-8">
            ...
            <?php if(isset($editMode) && $editMode): ?>
                <div class="editable-section mb-6">
                    <p class="text-xl md:text-2xl font-light leading-relaxed" style="color: <?php echo e($settings->home_description_color ?? $textColor); ?>"><?php echo e($settings->home_description ?? 'Su próximo vehículo lo espera. Más de 15 años ofreciendo las mejores opciones del mercado con financiamiento a medida.'); ?></p>
            ...
            <?php else: ?>
                <p class="text-xl md:text-2xl font-light leading-relaxed mb-6" style="color: <?php echo e($settings->home_description_color ?? $textColor); ?>"><?php echo e($settings->home_description ?? 'Su próximo vehículo lo espera. Más de 15 años ofreciendo las mejores opciones del mercado con financiamiento a medida.'); ?></p>
            <?php endif; ?>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="flex items-end justify-between mb-8">
                    <div>
                        ...
                        <?php if(isset($titleColor)): ?>
                            <h3 class="text-3xl font-bold" style="color: <?php echo e($titleColor); ?>">Vehículos Disponibles</h3>
                        <?php else: ?>
                            <?php
                                $bgColor = $settings->secondary_color ?? '#f8fafc';
                    ...
                    <span class="badge text-white" style="background: var(--primary-color);"><?php echo e($vehicles->count()); ?> unidades</span>
                </div>
                    ...
                    <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="vehicle-row p-4 lg:p-0">
                            ...
                            <div class="lg:hidden flex flex-col gap-3 p-2">
                                <img src="<?php echo e($vehicle->main_image); ?>" alt="<?php echo e($vehicle->title); ?>" class="w-full h-48 object-cover rounded-lg">
                                <div>
                                    <p class="text-xs font-medium uppercase tracking-wide text-gray-400"><?php echo e($vehicle->brand); ?></p>
                                    <h4 class="text-lg font-semibold text-gray-900"><?php echo e($vehicle->title); ?></h4>
                                    <div class="flex items-center gap-3 mt-2">
                                        <span class="badge bg-gray-100 text-gray-700"><?php echo e($vehicle->year); ?></span>
                                        <span class="badge bg-gray-100 text-gray-700"><?php echo e(number_format($vehicle->kilometers)); ?> km</span>
                                    </div>
                                    <div class="flex items-center justify-between mt-3">
                                        <span class="text-xl font-bold" style="color: var(--primary-color);">$<?php echo e(number_format($vehicle->price)); ?></span>
                                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $settings->whatsapp ?? '')); ?>?text=Hola! Estoy interesado en el <?php echo e(urlencode($vehicle->title)); ?>" target="_blank" class="px-4 py-2 text-xs font-semibold text-white rounded-lg transition hover:opacity-90" style="background: #25d366;">WhatsApp</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="hidden lg:grid grid-cols-12 gap-4 items-center px-6 py-4">
                                <div class="col-span-2">
                                    <img src="<?php echo e($vehicle->main_image); ?>" alt="<?php echo e($vehicle->title); ?>" class="w-28 h-20 object-cover rounded-lg">
                                </div>
                                <div class="col-span-3">
                                    <p class="text-[10px] font-semibold uppercase tracking-wider text-gray-400 mb-0.5"><?php echo e($vehicle->brand); ?></p>
                                    <h4 class="text-sm font-semibold text-gray-900"><?php echo e($vehicle->title); ?></h4>
                                    <p class="text-xs text-gray-400 mt-1"><?php echo e(Str::limit($vehicle->description, 60)); ?></p>
                                </div>
                                <div class="col-span-1">
                                    <span class="badge bg-gray-100 text-gray-700"><?php echo e($vehicle->year); ?></span>
                                </div>
                                <div class="col-span-2">
                                    <span class="text-sm text-gray-600"><?php echo e(number_format($vehicle->kilometers)); ?> km</span>
                                </div>
                                <div class="col-span-2">
                                    <span class="text-lg font-bold" style="color: var(--primary-color);">$<?php echo e(number_format($vehicle->price)); ?></span>
                                </div>
                                <div class="col-span-2 text-right">
                                    <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $settings->whatsapp ?? '')); ?>?text=Hola! Estoy interesado en el <?php echo e(urlencode($vehicle->title)); ?>" target="_blank" class="px-5 py-2 text-xs font-semibold text-white rounded-lg transition hover:opacity-90 hover:shadow-lg inline-block" style="background: #25d366;">WhatsApp</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="text-center mt-8">
                    <a href="<?php echo e(route('public.vehiculos')); ?>" class="inline-flex items-center gap-2 text-sm font-semibold transition hover:gap-3" style="color: var(--primary-color);">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                <div>
                    ...
                    <?php if(isset($editMode) && $editMode): ?>
                        <div class="editable-section mb-6">
                            <p class="text-gray-600 text-base leading-relaxed whitespace-pre-line" style="color: <?php echo e($settings->nosotros_description_color ?? '#4b5563'); ?>"><?php echo e($settings->nosotros_description ?? "Somos una empresa automotriz comprometida con la excelencia en el servicio.\n\nContamos con un equipo profesional dedicado a encontrar el vehículo ideal para cada cliente, con opciones de financiamiento adaptadas a sus necesidades."); ?></p>
                            <div class="edit-btn" onclick="editText('nosotros_description','Editar Descripción Empresa')"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="14" height="14" fill="currentColor" style="vertical-align:middle"><path d="M12.146.854a.5.5 0 0 1 .708 0l2.292 2.292a.5.5 0 0 1 0 .708l-9.5 9.5a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l9.5-9.5z"/></svg></div>
                        </div>
                    <?php else: ?>
                        <p class="text-gray-600 text-base leading-relaxed whitespace-pre-line mb-6" style="color: <?php echo e($settings->nosotros_description_color ?? '#4b5563'); ?>"><?php echo e($settings->nosotros_description ?? "Somos una empresa automotriz comprometida con la excelencia en el servicio.\n\nContamos con un equipo profesional dedicado a encontrar el vehículo ideal para cada cliente, con opciones de financiamiento adaptadas a sus necesidades."); ?></p>
                    <?php endif; ?>
                    <?php if(isset($editMode) && $editMode): ?>
                        <div class="editable-section flex gap-10 pt-6 border-t border-gray-200">
                            <div>
                                <div class="text-2xl font-bold" style="color: var(--primary-color);"><?php echo e($settings->stat1 ?? '500+'); ?></div>
                                <p class="text-xs text-gray-500 mt-0.5"><?php echo e($settings->stat1_label ?? 'Clientes Satisfechos'); ?></p>
                            </div>
                            <div>
                                <div class="text-2xl font-bold" style="color: var(--primary-color);"><?php echo e($settings->stat2 ?? '15+'); ?></div>
                                <p class="text-xs text-gray-500 mt-0.5"><?php echo e($settings->stat2_label ?? 'Años Experiencia'); ?></p>
                            </div>
                            <div>
                                <div class="text-2xl font-bold" style="color: var(--primary-color);"><?php echo e($settings->stat3 ?? '100%'); ?></div>
                                <p class="text-xs text-gray-500 mt-0.5"><?php echo e($settings->stat3_label ?? 'Documentación Legal'); ?></p>
                            </div>
                ...
                <div class="relative">
                    <?php if(isset($editMode) && $editMode): ?>
                        <div class="editable-section rounded-2xl overflow-hidden shadow-xl">
                            <img src="<?php echo e($settings->nosotros_url ?? 'https://images.unsplash.com/photo-1560958089-b8a1929cea89?w=800&h=600&fit=crop'); ?>" alt="Empresa" class="w-full h-80 object-cover">
            ...
            <div class="max-w-7xl mx-auto">
                <div class="text-center mb-12">
                    <p class="text-xs font-semibold uppercase tracking-wider mb-2" style="color: var(--primary-color);">¿Necesita asesoramiento?</p>
                        ...
                        <?php if(isset($titleColor)): ?>
                            <h3 class="text-3xl font-bold" style="color: <?php echo e($titleColor); ?>">Contáctenos</h3>
                        <?php else: ?>
                            <?php
                                $bgColor = $settings->secondary_color ?? '#f8fafc';
                                if (!function_exists('isDark_corp')) {
                ...
                <div class="grid grid-cols-1 lg:grid-cols-5 gap-0 rounded-2xl overflow-hidden border border-gray-200 shadow-lg">
                    ...
                    <div class="lg:col-span-2 p-10 text-white" style="background: var(--primary-color);">
                        ...
                        <div class="space-y-6">
                            <?php if($settings->phone): ?>
                                <a href="tel:<?php echo e($settings->phone); ?>" class="flex items-center gap-4 text-white/90 hover:text-white transition">
                                    <div class="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center flex-shrink-0">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                                    </div>
                                    <span class="text-sm"><?php echo e($settings->phone); ?></span>
                                </a>
                            <?php endif; ?>
                            <?php if($settings->email): ?>
                                <a href="mailto:<?php echo e($settings->email); ?>" class="flex items-center gap-4 text-white/90 hover:text-white transition">
                                    <div class="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center flex-shrink-0">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                                    </div>
                                    <span class="text-sm"><?php echo e($settings->email); ?></span>
                                </a>
                            <?php endif; ?>
                            <?php if($settings->whatsapp): ?>
                                <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $settings->whatsapp)); ?>" target="_blank" class="flex items-center gap-4 text-white/90 hover:text-white transition">
                                    <div class="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center flex-shrink-0">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
                                    </div>
                                    <span class="text-sm">WhatsApp: <?php echo e($settings->whatsapp); ?></span>
                                </a>
                            <?php endif; ?>
                            <?php if($settings->address): ?>
                                <div class="flex items-center gap-4 text-white/90">
                                    ...
                                    <span class="text-sm"><?php echo e($settings->address); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>

                        <div class="flex gap-4 mt-14">
                            <?php if($settings->facebook_url): ?><a href="<?php echo e($settings->facebook_url); ?>" target="_blank" class="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-white/70 hover:bg-white/20 hover:text-white transition text-xs font-bold">Fb</a><?php endif; ?>
                            <?php if($settings->instagram_url): ?><a href="<?php echo e($settings->instagram_url); ?>" target="_blank" class="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-white/70 hover:bg-white/20 hover:text-white transition text-xs font-bold">Ig</a><?php endif; ?>
                            <?php if($settings->linkedin_url): ?><a href="<?php echo e($settings->linkedin_url); ?>" target="_blank" class="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-white/70 hover:bg-white/20 hover:text-white transition text-xs font-bold">Li</a><?php endif; ?>
                        </div>
                    </div>

                    <!-- Form Panel — derecha -->
                    <div class="lg:col-span-3 p-10" style="background: var(--tertiary-color);">
                        <form action="<?php echo e(\App\Helpers\RouteHelper::publicContactRoute()); ?>" method="POST" class="space-y-5">
                            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
                <div class="md:col-span-2">
                    <div class="flex items-center gap-3 mb-4">
                        <?php if($settings && $settings->logo_url): ?>
                            <img src="<?php echo e($settings->logo_url); ?>" alt="<?php echo e($tenant->name); ?>" class="h-8 object-contain brightness-200">
                        <?php else: ?>
                            <div class="h-8 w-8 rounded-lg flex items-center justify-center" style="background: var(--primary-color);">
                                <span class="text-white font-bold text-sm"><?php echo e(substr($tenant->name, 0, 1)); ?></span>
                            </div>
                        <?php endif; ?>
                        <span class="text-white font-semibold"><?php echo e($tenant->name); ?></span>
                    </div>
                    <p class="text-sm leading-relaxed"><?php echo e($settings->contact_message ?? 'Su concesionario de confianza. Vehículos verificados, financiamiento a medida y atención personalizada.'); ?></p>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="<?php echo e(route('public.vehiculos')); ?>" class="hover:text-white transition">Inventario</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <?php if($settings->phone): ?><li><?php echo e($settings->phone); ?></li><?php endif; ?>
                        <?php if($settings->email): ?><li><?php echo e($settings->email); ?></li><?php endif; ?>
                        <?php if($settings->address): ?><li><?php echo e($settings->address); ?></li><?php endif; ?>
                    </ul>
                </div>
            </div>
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views/public/templates/corporativo.blade.php ENDPATH**/ ?>