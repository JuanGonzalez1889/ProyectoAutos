        ...
        <div class="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
            ...
            <div class="flex items-center gap-8">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-sm font-medium text-gray-500 hover:text-gray-900 border border-gray-300 px-4 py-1.5 rounded-lg transition">Panel</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
        ...
        <div class="relative z-10 text-center max-w-3xl mx-auto px-8">
            ...
            <?php if(isset($editMode) && $editMode): ?>
                <div class="editable-section mb-6">
                    <p class="text-xl md:text-2xl text-white/90 font-light leading-relaxed" style="color: <?php echo e($settings->home_description_color ?? 'rgba(255,255,255,0.9)'); ?>"><?php echo e($settings->home_description ?? 'Su próximo vehículo lo espera. Más de 15 años ofreciendo las mejores opciones del mercado con financiamiento a medida.'); ?></p>
                    <div class="edit-btn" onclick="editText('home_description','Editar Descripción')"><i class="fa fa-pencil"></i></div>
                </div>
            <?php else: ?>
                <p class="text-xl md:text-2xl text-white/90 font-light leading-relaxed mb-6" style="color: <?php echo e($settings->home_description_color ?? 'rgba(255,255,255,0.9)'); ?>"><?php echo e($settings->home_description ?? 'Su próximo vehículo lo espera. Más de 15 años ofreciendo las mejores opciones del mercado con financiamiento a medida.'); ?></p>
            <?php endif; ?>
                        ...
                        <div class="vehicle-row p-4 lg:p-0">
                            ...
                            <div class="lg:hidden flex flex-col gap-3 p-2">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center justify-between mt-3">
                                        ...
                                        <button type="button" onclick="openContactForm('<?php echo e($vehicle->id); ?>', '<?php echo e($vehicle->title); ?>')" class="px-4 py-2 text-xs font-semibold text-white rounded-lg transition hover:opacity-90" style="background: var(--primary-color);">Consultar</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="hidden lg:grid grid-cols-12 gap-4 items-center px-6 py-4">
                                ...
                                <div class="col-span-2 text-right">
                                    <button type="button" onclick="openContactForm('<?php echo e($vehicle->id); ?>', '<?php echo e($vehicle->title); ?>')" class="px-5 py-2 text-xs font-semibold text-white rounded-lg transition hover:opacity-90 hover:shadow-lg" style="background: var(--primary-color);">Consultar</button>
                                </div>
                            </div>
                        </div>
