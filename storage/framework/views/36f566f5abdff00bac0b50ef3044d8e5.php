        ...
        <div class="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-7">
                <a href="#vehiculos" class="text-sm font-medium transition hover:text-gray-900"
                    style="color: <?php echo e($settings->navbar_links_color ?? '#6b7280'); ?>">Inventario</a>
                            ...
                            <div class="p-5">
                                ...
                                <div class="flex items-center gap-4 text-xs text-gray-400 mb-4">
                                    <span class="flex items-center gap-1">
                                        ...
                                        <?php echo e(number_format($vehicle->kilometers / 1000, 1)); ?>k
                                    </span>
                                    <span class="flex items-center gap-1">
                                        <svg class="w-3.5 h-3.5" style="color: var(--primary-color);" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views/public/templates/innovador.blade.php ENDPATH**/ ?>