    ...
    <script>
        ...
        async function saveImage() {
            ...
            if (fileInput.files && fileInput.files[0]) {
                ...
                try {
                    const response = await fetch('<?php echo e(parse_url(route("admin.landing-config.upload-image"), PHP_URL_PATH)); ?>', {
                        method: 'POST',
                        headers: {
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="vehicle-card group">
                        <a href="<?php echo e(route('public.vehiculos.show', $vehicle->id)); ?>" class="block relative">
                        ...
                        <div class="mt-3">
                            ...
                            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $settings->whatsapp ?? '')); ?>?text=Hola! Estoy interesado en el <?php echo e(urlencode($vehicle->title)); ?>" target="_blank" class="w-full py-2 rounded-lg font-black text-xs text-white transition hover:shadow-lg text-center flex items-center justify-center gap-1.5" style="background: #25d366;">
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\templates\deportivo.blade.php ENDPATH**/ ?>