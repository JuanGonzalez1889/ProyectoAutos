    ...
    <nav class="sticky top-0 z-50 backdrop-blur-lg border-b" style="border-color: var(--primary-color);">
        <div class="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center relative">
            ...
            <div class="hidden md:flex items-center gap-6">
                <a href="/" class="navbar-link-auto transition" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">INICIO</a>
                <a href="<?php echo e(route('public.vehiculos')); ?>" class="navbar-link-auto transition" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">VEHÍCULOS</a>
                <a href="/#nosotros" class="navbar-link-auto transition" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">NOSOTROS</a>
                <a href="/#contacto" class="navbar-link-auto transition" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">CONTACTO</a>
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\templates\deportivo-base.blade.php ENDPATH**/ ?>