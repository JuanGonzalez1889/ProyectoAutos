...
<?php $__env->startSection('page-title', 'Editar Vehículo'); ?>
...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            ...
            <p class="text-sm text-[hsl(var(--muted-foreground))]"><?php echo e($vehicle->title); ?></p>
        </div>
    </div>

    <form action="<?php echo e(route('admin.vehicles.update', $vehicle)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="relative group">
                    <img src="<?php echo e($image); ?>" alt="Imagen <?php echo e($index + 1); ?>" class="w-full h-32 object-cover rounded-lg">
                    <label class="absolute top-2 right-2 p-1 bg-red-500 hover:bg-red-600 rounded cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity">
                        <input type="checkbox" name="existing_images[]" value="<?php echo e($image); ?>" checked class="sr-only">
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="title" value="<?php echo e(old('title', $vehicle->title)); ?>" required
                ...
                <div>
                    ...
                    <input type="text" name="brand" value="<?php echo e(old('brand', $vehicle->brand)); ?>" required
                           class="w-full h-10 px-3 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-sm focus:outline-none focus:border-[hsl(var(--primary))]">
                </div>

                <div>
                    <label class="block text-sm font-medium mb-2">Modelo</label>
                    <input type="text" name="model" value="<?php echo e(old('model', $vehicle->model)); ?>" required
                           class="w-full h-10 px-3 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-sm focus:outline-none focus:border-[hsl(var(--primary))]">
                </div>

                <div>
                    <label class="block text-sm font-medium mb-2">Año</label>
                    <input type="number" name="year" value="<?php echo e(old('year', $vehicle->year)); ?>" required
                ...
                <div>
                    ...
                    <input type="number" name="price" value="<?php echo e(old('price', $vehicle->price)); ?>" required
                           min="0" step="0.01"
                           class="w-full h-10 px-3 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-sm focus:outline-none focus:border-[hsl(var(--primary))]">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="price_original" value="<?php echo e(old('price_original', $vehicle->price_original)); ?>"
                           min="0" step="0.01"
                           class="w-full h-10 px-3 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-sm focus:outline-none focus:border-[hsl(var(--primary))]">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="kilometers" value="<?php echo e(old('kilometers', $vehicle->kilometers)); ?>"
                           min="0"
                           class="w-full h-10 px-3 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-sm focus:outline-none focus:border-[hsl(var(--primary))]">
                </div>
                ...
                <div>
                    ...
                    <select name="fuel_type"
                        ...
                        <option value="Nafta" <?php echo e(old('fuel_type', $vehicle->fuel_type) === 'Nafta' ? 'selected' : ''); ?>>Nafta</option>
                        <option value="Diesel" <?php echo e(old('fuel_type', $vehicle->fuel_type) === 'Diesel' ? 'selected' : ''); ?>>Diesel</option>
                        <option value="GNC" <?php echo e(old('fuel_type', $vehicle->fuel_type) === 'GNC' ? 'selected' : ''); ?>>GNC</option>
                        <option value="Eléctrico" <?php echo e(old('fuel_type', $vehicle->fuel_type) === 'Eléctrico' ? 'selected' : ''); ?>>Eléctrico</option>
                        <option value="Híbrido" <?php echo e(old('fuel_type', $vehicle->fuel_type) === 'Híbrido' ? 'selected' : ''); ?>>Híbrido</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="transmission"
                        ...
                        <option value="Automático" <?php echo e(old('transmission', $vehicle->transmission) === 'Automático' ? 'selected' : ''); ?>>Automático</option>
                    </select>
                </div>

                <div>
                    <label class="block text-sm font-medium mb-2">Placa</label>
                    <input type="text" name="plate" value="<?php echo e(old('plate', $vehicle->plate)); ?>"
                           class="w-full h-10 px-3 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-sm focus:outline-none focus:border-[hsl(var(--primary))]">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="5" required
                              class="w-full px-3 py-2 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-sm focus:outline-none focus:border-[hsl(var(--primary))]"><?php echo e(old('description', $vehicle->description)); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="contact_name" value="<?php echo e(old('contact_name', $vehicle->contact_name)); ?>"
                           class="w-full h-10 px-3 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-sm focus:outline-none focus:border-[hsl(var(--primary))]">
                </div>

                <div>
                    <label class="block text-sm font-medium mb-2">Teléfono</label>
                    <input type="text" name="contact_phone" value="<?php echo e(old('contact_phone', $vehicle->contact_phone)); ?>"
                           class="w-full h-10 px-3 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-sm focus:outline-none focus:border-[hsl(var(--primary))]">
                </div>

                <div>
                    <label class="block text-sm font-medium mb-2">Email</label>
                    <input type="email" name="contact_email" value="<?php echo e(old('contact_email', $vehicle->contact_email)); ?>"
                           class="w-full h-10 px-3 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-sm focus:outline-none focus:border-[hsl(var(--primary))]">
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="status" id="status-select" required
                        ...
                        <option value="draft" <?php echo e(old('status', $vehicle->status) === 'draft' ? 'selected' : ''); ?>>Borrador</option>
                        <option value="published" <?php echo e(old('status', $vehicle->status) === 'published' ? 'selected' : ''); ?>>Publicado</option>
                        <option value="sold" <?php echo e(old('status', $vehicle->status) === 'sold' ? 'selected' : ''); ?>>Vendido</option>
                    </select>
                </div>
                <div>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="featured" value="1" <?php echo e(old('featured', $vehicle->featured) ? 'checked' : ''); ?>
            ...
            <div id="sold-price-field" style="display: <?php echo e(old('status', $vehicle->status) === 'sold' ? 'block' : 'none'); ?>;" class="mt-4">
                <label class="block text-sm font-medium mb-2">Precio de Venta Real</label>
                <input type="number" name="sold_price" min="0" step="1000" value="<?php echo e(old('sold_price', $vehicle->sold_price)); ?>"
                       class="w-full h-10 px-3 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-sm focus:outline-none focus:border-[hsl(var(--primary))]"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\admin\vehicles\edit.blade.php ENDPATH**/ ?>