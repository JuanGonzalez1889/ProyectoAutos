    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center bg-[hsl(var(--background))] p-8">
        <div class="w-full max-w-md space-y-6">
            ...
            <div class="flex border-b border-[hsl(var(--border))]">
                <a href="<?php echo e(route('login')); ?>" class="flex-1 pb-3 text-sm font-medium text-[hsl(var(--muted-foreground))] hover:text-white text-center">
                    Iniciar Sesión
                </a>
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="agency_name" name="agency_name" value="<?php echo e(old('agency_name')); ?>" required
                               class="w-full pl-10 pr-4 py-3 bg-[#1a1f26] border border-[hsl(var(--border))] rounded-lg text-white placeholder-[hsl(var(--muted-foreground))] focus:outline-none focus:ring-2 focus:ring-[hsl(var(--ring))]"
                ...
                <div class="space-y-3">
                    <div class="flex items-start space-x-2">
                        <input type="checkbox" id="terms_accepted" name="terms_accepted" value="1" 
                               <?php echo e(old('terms_accepted') ? 'checked' : ''); ?>
                        ...
                        <label for="terms_accepted" class="text-sm text-[hsl(var(--muted-foreground))] cursor-pointer leading-relaxed">
                            ...
                            <a href="<?php echo e(route('legal.terms')); ?>" target="_blank" class="text-[hsl(var(--primary))] hover:underline font-medium">Términos y Condiciones</a>.
                        </label>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-start space-x-2">
                        ...
                        <label for="privacy_accepted" class="text-sm text-[hsl(var(--muted-foreground))] cursor-pointer leading-relaxed">
                            ...
                            <a href="<?php echo e(route('legal.privacy')); ?>" target="_blank" class="text-[hsl(var(--primary))] hover:underline font-medium">Política de Privacidad</a>.
                        </label>
                    </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <script>
            grecaptcha.ready(function() {
                grecaptcha.execute('<?php echo config('services.recaptcha.site_key'); ?>', {action: })
                .then(function(token) {
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\auth\register.blade.php ENDPATH**/ ?>