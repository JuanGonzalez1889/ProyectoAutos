...
<?php $__env->startSection('page-title', 'Mis Tareas'); ?>
        ...
        <div class="p-4 bg-gradient-to-br from-gray-500/10 to-gray-600/10 border border-gray-500/20 rounded-lg">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white"><?php echo e($stats['pendiente']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="p-4 bg-gradient-to-br from-green-500/10 to-green-600/10 border border-green-500/20 rounded-lg">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white"><?php echo e($stats['completo']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="p-4 bg-gradient-to-br from-red-500/10 to-red-600/10 border border-red-500/20 rounded-lg">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white"><?php echo e($stats['cancelado']); ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between p-4 bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-lg">
                <div class="flex items-center gap-2">
                    ...
                    <span class="px-2 py-0.5 text-xs font-medium rounded bg-gray-500/20 text-gray-500"><?php echo e(count($tasks['pendiente'])); ?></span>
                </div>
            </div>

            <div class="space-y-3 min-h-[400px]">
                <?php $__empty_1 = true; $__currentLoopData = $tasks['pendiente']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="card hover:border-[hsl(var(--primary))]/50 transition-colors cursor-move" 
                    ...
                    <div class="mb-2">
                        ...
                        <select class="estado-select bg-gray-800 text-white rounded px-2 py-1 text-xs" data-task-id="<?php echo e($task->id); ?>">
                            <option value="pendiente" <?php if($task->status==="pendiente"): ?> selected <?php endif; ?>>Pendiente</option>
                            <option value="completado" <?php if($task->status==="completado"): ?> selected <?php endif; ?>>Completado</option>
                            <option value="cancelado" <?php if($task->status==="cancelado"): ?> selected <?php endif; ?>>Cancelado</option>
                        </select>
                    </div>
                    <div class="flex items-start justify-between mb-2">
                        <h4 class="font-semibold text-white text-sm"><?php echo e($task->title); ?></h4>
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-transition style="display: none;"
                                ...
                                <a href="#" @click.prevent="editTask(<?php echo e($task->id); ?>)" 
                                   class="block px-3 py-2 text-sm hover:bg-[hsl(var(--muted))] transition-colors">Editar</a>
                                <form action="<?php echo e(route('admin.tasks.destroy', $task)); ?>" method="POST" 
                    ...
                    <p class="text-xs text-[hsl(var(--muted-foreground))] mb-3 line-clamp-2"><?php echo e($task->description); ?></p>
                    <?php endif; ?>
                    ...
                    <div class="flex items-center justify-between">
                        <span class="px-2 py-0.5 text-xs font-medium rounded 
                            ...
                            <?php else: ?> bg-green-500/20 text-green-500 <?php endif; ?>">
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between p-4 bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-lg">
                <div class="flex items-center gap-2">
                    ...
                    <span class="px-2 py-0.5 text-xs font-medium rounded bg-red-500/20 text-red-500"><?php echo e(count($tasks['cancelado'])); ?></span>
                </div>
            </div>

            <div class="space-y-3 min-h-[400px]">
                <?php $__empty_1 = true; $__currentLoopData = $tasks['cancelado']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="card hover:border-[hsl(var(--primary))]/50 transition-colors cursor-move" 
                     draggable="true"
                     data-task-id="<?php echo e($task->id); ?>">
                    <div class="mb-2">
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between p-4 bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-lg">
                <div class="flex items-center gap-2">
                    ...
                    <span class="px-2 py-0.5 text-xs font-medium rounded bg-green-500/20 text-green-500"><?php echo e(count($tasks['completo'])); ?></span>
                </div>
            </div>

            <div class="space-y-3 min-h-[400px]">
                <?php $__empty_1 = true; $__currentLoopData = $tasks['completo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="card opacity-75 hover:opacity-100 hover:border-[hsl(var(--primary))]/50 transition-all cursor-move" 
                    ...
                    <div class="flex items-start justify-between mb-2">
                        <h4 class="font-semibold text-white text-sm line-through"><?php echo e($task->title); ?></h4>
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" @click.away="open = false"
                                    class="p-1 hover:bg-[hsl(var(--muted))] rounded transition-colors">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
...
<div id="taskModal" class="hidden fixed inset-0 z-50 overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="relative bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-lg p-6 max-w-lg w-full">
            ...
            <form action="<?php echo e(route('admin.tasks.store')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\tasks\index.blade.php ENDPATH**/ ?>