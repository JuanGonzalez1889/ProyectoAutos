...
<div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <span class="h-12 px-4 flex items-center bg-[hsl(var(--muted))] border border-[hsl(var(--border))] rounded-r-lg text-sm text-[hsl(var(--muted-foreground))] whitespace-nowrap font-medium">
                            <?php echo e($onboarding['domain_suffix'] ?? '.misaas.com'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <?php if($stats['top_vehicles']->count() > 0): ?>
                ...
                <div class="card p-0 overflow-hidden relative">
                    <div class="relative h-40 bg-gradient-to-br from-gray-700 to-gray-900">
                        <?php if($vehicle->image_url): ?>
                            <img src="<?php echo e($vehicle->image_url); ?>" 
                                 alt="<?php echo e($vehicle->marca); ?> <?php echo e($vehicle->modelo); ?>" 
                    ...
                    <div class="p-4">
                        <h3 class="font-semibold text-white mb-1"><?php echo e($vehicle->marca); ?> <?php echo e($vehicle->modelo); ?> <?php echo e($vehicle->anio); ?></h3>
                        <p class="text-xs text-[hsl(var(--muted-foreground))] mb-2">Vistas: <?php echo e($vehicle->views ?? 0); ?></p>
                        <div class="flex items-center justify-between">
                            <p class="text-lg font-bold text-[hsl(var(--primary))]">$<?php echo e(number_format($vehicle->precio, 0)); ?></p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Juan Gonzalez\Desktop\JuanMauro\ProyectoAutos\resources\views/agenciero/dashboard.blade.php ENDPATH**/ ?>