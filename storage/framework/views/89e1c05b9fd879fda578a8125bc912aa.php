        ...
        <div class="max-w-7xl mx-auto px-6 py-4">
            ...
            <div class="flex items-center justify-center gap-10">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-xs tracking-[0.2em] uppercase px-4 py-1.5 border transition" style="color: var(--primary-color); border-color: rgba(201,169,110,0.3);">Panel</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
                        ...
                        <div class="vehicle-showcase rounded-sm overflow-hidden">
                            ...
                            <div class="flex flex-col justify-between p-8" style="background: linear-gradient(180deg, rgba(15,15,15,0.98), rgba(10,10,10,0.99));">
                                ...
                                <div>
                                    ...
                                    <button type="button" onclick="openContactForm('<?php echo e($vehicle->id); ?>', '<?php echo e($vehicle->title); ?>')"
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views/public/templates/elegante.blade.php ENDPATH**/ ?>