                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 glass">
                            <a href="<?php echo e(route('public.vehiculos.show', $vehicle->id)); ?>" class="block relative h-40 bg-gray-700 overflow-hidden">
                            ...
                            <div class="p-4">
                                <a href="<?php echo e(route('public.vehiculos.show', $vehicle->id)); ?>" class="block"><h4 class="text-lg font-bold mb-2 line-clamp-1 hover:underline"><?php echo e($vehicle->title); ?></h4></a>
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\templates\moderno.blade.php ENDPATH**/ ?>