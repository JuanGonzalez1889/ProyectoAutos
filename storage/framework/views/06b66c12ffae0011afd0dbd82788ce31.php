                ...
                <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border-2 rounded-lg overflow-hidden hover:shadow-xl hover:-translate-y-2 transition transform" style="border-color: var(--primary-color);">
                        ...
                        <div class="p-4">
                            ...
                            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $settings->whatsapp ?? '')); ?>?text=Hola! Estoy interesado en el <?php echo e(urlencode($vehicle->title)); ?>" target="_blank" class="w-full py-2 text-white font-semibold rounded text-xs transition hover:opacity-90 text-center flex items-center justify-center gap-1.5" style="background: #25d366;">
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views/public/templates/clasico.blade.php ENDPATH**/ ?>