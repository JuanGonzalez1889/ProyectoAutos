    ...
    <div class="max-w-4xl mx-auto">
        <div class="card">
            <div class="p-8">
                ...
                <p class="text-sm text-[hsl(var(--muted-foreground))] mb-8">Última actualización: <?php echo e(date('d/m/Y')); ?></p>
                ...
                <div class="mt-8 pt-8 border-t border-[hsl(var(--border))]">
                    <a href="<?php echo e(route('landing.home')); ?>" class="text-blue-400 hover:text-blue-300">← Volver al inicio</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\legal\privacy.blade.php ENDPATH**/ ?>