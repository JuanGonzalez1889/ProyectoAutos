...
<div class="max-w-4xl mx-auto px-4 py-12" style="font-family: <?php echo e($settings->font_family ?? 'inherit'); ?>;">
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="md:w-1/2 flex flex-col">
            <h1 class="text-3xl font-bold mb-2 vehiculo-card-auto"><?php echo e($vehicle->title); ?></h1>
            ...
            <form action="/contacto" method="POST" class="mb-4">
                ...
                <input type="text" name="name" placeholder="Tu Nombre" required class="w-full px-4 py-2 mb-2 rounded vehiculo-card-auto" style="background: var(--secondary-color); border: 1px solid rgba(255,255,255,0.1);">
                <input type="email" name="email" placeholder="Tu Email" required class="w-full px-4 py-2 mb-2 rounded vehiculo-card-auto" style="background: var(--secondary-color); border: 1px solid rgba(255,255,255,0.1);">
                <input type="tel" name="phone" placeholder="Tu Teléfono" required class="w-full px-4 py-2 mb-2 rounded vehiculo-card-auto" style="background: var(--secondary-color); border: 1px solid rgba(255,255,255,0.1);">
                <textarea name="message" placeholder="Mensaje" rows="3" required class="w-full px-4 py-2 mb-2 rounded vehiculo-card-auto" style="background: var(--secondary-color); border: 1px solid rgba(255,255,255,0.1);"></textarea>
            ...
            <?php if($vehicle->whatsapp ?? $settings->whatsapp ?? false): ?>
                <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $vehicle->whatsapp ?? $settings->whatsapp ?? '')); ?>?text=Hola! Estoy interesado en el <?php echo e($vehicle->title); ?>" target="_blank" class="w-full py-2 rounded font-semibold text-center block" style="background: #25d366; color: #fff;">Consultar por WhatsApp</a>
            <?php endif; ?>
        </div>
    </div>
</div>
...
<?php echo $__env->make('public.templates.tecnologico-base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\vehiculos\show-tecnologico.blade.php ENDPATH**/ ?>