...
<head>
    ...
    <title><?php echo e($tenant->name ?? 'Agencia de Autos'); ?> - Plataforma Digital</title>
    ...
    <style>
        :root {
            ...
            --secondary-color: <?php echo e($settings && $settings->secondary_color ? $settings->secondary_color : '#fafbff'); ?>;
            --tertiary-color: <?php echo e($settings && $settings->tertiary_color ? $settings->tertiary_color : '#e0e7ff'); ?>;
        }
...
<body style="background-color: var(--secondary-color);" class="text-gray-800 antialiased">
    ...
    <nav class="sticky top-0 z-50" style="background: var(--secondary-color); backdrop-filter: blur(20px); border-bottom: 1px solid var(--tertiary-color);">
        <div class="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between">
                ...
                <?php if(isset($editMode) && $editMode): ?>
                    ...
                    <div class="editable-section inline-block relative"
                        ...
                        <span class="text-lg font-bold text-gray-900"
                            style="color: <?php echo e($settings->agency_name_color ?? '#111827'); ?>"><?php echo e($tenant->name); ?></span>
            ...
            <div class="hidden md:flex items-center gap-7">
                <a href="#inicio" class="text-sm font-medium transition hover:text-gray-900"
                    style="color: <?php echo e($settings->navbar_links_color ?? '#6b7280'); ?>">Inicio</a>
                <a href="<?php echo e(route('public.vehiculos')); ?>" class="text-sm font-medium transition hover:text-gray-900"
                    style="color: <?php echo e($settings->navbar_links_color ?? '#6b7280'); ?>">Vehículos</a>
                <a href="#nosotros" class="text-sm font-medium transition hover:text-gray-900"
                    style="color: <?php echo e($settings->navbar_links_color ?? '#6b7280'); ?>">Nosotros</a>
                <a href="#contacto" class="text-sm font-medium transition hover:text-gray-900"
                    style="color: <?php echo e($settings->navbar_links_color ?? '#6b7280'); ?>">Contacto</a>
            </div>
        ...
        <div id="mobile-menu"
            ...
            <button id="menu-close" class="absolute top-6 right-6 text-gray-900 text-3xl focus:outline-none"
                ...
                <a href="#inicio" class="text-sm font-medium transition hover:text-gray-900"
                    style="color: <?php echo e($settings->navbar_links_color ?? '#6b7280'); ?>">Inicio</a>
            <a href="<?php echo e(route('public.vehiculos')); ?>" class="navbar-link-auto text-gray-900">Vehículos</a>
                ...
                <?php if(isset($editMode) && $editMode): ?>
                    <div class="editable-section mb-6 relative">
                        <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight">
                            <span class="text-white"><?php echo e($settings->hero_title ?? 'Eleva la Presencia Digital de tu Concesionario'); ?></span>
                        </h1>
                ...
                <?php if(isset($editMode) && $editMode): ?>
                    <div class="editable-section mb-8">
                        <p class="text-base leading-relaxed max-w-lg"
                            style="color: <?php echo e($settings->home_description_color ?? '#6b7280'); ?>">
            ...
            <?php if(isset($editMode) && $editMode): ?>
                <div class="editable-section w-full h-full absolute inset-0">
                    <?php if($settings && $settings->banner_url): ?>
                        <img src="<?php echo e($settings->banner_url); ?>" alt="Showcase"
                        ...
                        <div class="vehicle-card-light group">
                            ...
                            <div class="p-5">
                                <div class="flex items-center gap-2 mb-1">
                                    <span
                                        class="text-[10px] font-bold uppercase tracking-wider text-gray-400"><?php echo e($vehicle->year); ?></span>
                                    <span class="text-gray-200">·</span>
                                    <span
                                        class="text-[10px] font-bold uppercase tracking-wider text-gray-400"><?php echo e($vehicle->brand); ?></span>
                                </div>
                                <h4 class="text-base font-bold text-gray-900 mb-3"><?php echo e($vehicle->title); ?></h4>
                                <!-- Specs row -->
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                    <span
                                        class="text-xl font-bold text-gray-900">$<?php echo e(number_format($vehicle->price)); ?></span>
                ...
                <div>
                    ...
                    <?php if(isset($editMode) && $editMode): ?>
                        <div class="editable-section mb-6">
                            <p class="text-base text-gray-500 leading-relaxed whitespace-pre-line"
                                style="color: <?php echo e($settings->nosotros_description_color ?? '#6b7280'); ?>">
                    ...
                    <?php if(isset($editMode) && $editMode): ?>
                        <div class="editable-section flex gap-8 pt-6 border-t border-gray-200">
                            <div>
                                <div class="text-2xl font-bold text-gray-900"><?php echo e($settings->stat1 ?? '500+'); ?></div>
                                <p class="text-xs text-gray-400 mt-0.5">
                                    <?php echo e($settings->stat1_label ?? 'Concesionarios'); ?></p>
                            </div>
                            <div>
                                <div class="text-2xl font-bold text-gray-900"><?php echo e($settings->stat2 ?? '98%'); ?></div>
                                <p class="text-xs text-gray-400 mt-0.5"><?php echo e($settings->stat2_label ?? 'Satisfacción'); ?>

                                </p>
                            </div>
                            <div>
                                <div class="text-2xl font-bold text-gray-900"><?php echo e($settings->stat3 ?? '24/7'); ?></div>
                                <p class="text-xs text-gray-400 mt-0.5"><?php echo e($settings->stat3_label ?? 'Soporte'); ?></p>
                            </div>
    ...
    <div class="max-w-6xl mx-auto px-6 py-14">
        <div class="cta-dark px-10 py-16 text-center">
            ...
            <p class="text-white/60 text-base mb-8 max-w-lg mx-auto">Únete a cientos de clientes que ya confiaron en <?php echo e($tenant->name); ?>.</p>
            ...
            <div class="grid grid-cols-2 md:grid-cols-2 gap-10 mb-12">
                <div class="col-span-2 md:col-span-1">
                    ...
                    <p class="text-sm text-gray-500 leading-relaxed mb-5">
                        <?php echo e($settings->contact_message ?? 'Te ayudamos con la gestión de tu próximo vehículo.'); ?>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li><a href="<?php echo e(route('public.vehiculos')); ?>"
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\templates\innovador.blade.php ENDPATH**/ ?>