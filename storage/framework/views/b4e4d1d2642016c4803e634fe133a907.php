...
<?php $__env->startSection('title', 'Configuración de Visibilidad por Plan y Rol'); ?>
<?php $__env->startSection('page-title', 'Configurar visibilidad de módulos'); ?>
...
<div class="w-full p-6" style="">
    ...
    <?php endif; ?>
    <form method="POST" action="<?php echo e(route('admin.planes.configuracion.store')); ?>">
        <?php echo csrf_field(); ?>
...
">
                        ...
                        <?php $__currentLoopData = $permisos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permiso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <th class="px-4 py-2"><?php echo e($permiso); ?></th>
                    ...
                    <?php $__currentLoopData = $planes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr style="color: black;">
                                <td class="border px-4 py-2 col-plan"><?php echo e($plan->nombre); ?></td>
                                <td class="border px-4 py-2 col-rol"><?php echo e($rol->name); ?></td>
                                <?php $__currentLoopData = $permisos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permiso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <td class="border px-4 py-2 text-center">
                                        <input type="checkbox" name="permisos[<?php echo e($plan->slug); ?>][<?php echo e($rol->id); ?>][<?php echo e($permiso); ?>]" value="1" <?php echo e(($asign && $asign->visible) || $defaultChecked ? 'checked' : ''); ?>>
                                    </td>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\admin\planes\configuracion.blade.php ENDPATH**/ ?>