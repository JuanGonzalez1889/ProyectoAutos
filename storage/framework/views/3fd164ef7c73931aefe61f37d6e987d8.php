        ...
        <aside class="fixed left-0 top-0 h-full w-64 bg-[hsl(var(--card))] border-r border-[hsl(var(--border))] p-6 flex flex-col z-50">
            ...
            <div class="mb-8">
                ...
                <p class="text-xs text-[hsl(var(--muted-foreground))]">
                    ...
                    <?php elseif(auth()->user()->isAgenciero()): ?>
            ...
            <div class="mb-6 p-3 bg-[hsl(var(--secondary))]/50 rounded-lg">
                <div class="flex items-center gap-3 mb-3">
                    <?php if(auth()->user()->avatar): ?>
                        <img src="<?php echo e(auth()->user()->avatar); ?>" class="w-10 h-10 rounded-full" alt="Avatar">
                    <?php else: ?>
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium text-[hsl(var(--foreground))] truncate"><?php echo e(auth()->user()->name); ?></p>
                ...
                <div class="px-3 py-2 bg-transparent border border-[hsl(var(--border))] rounded-lg">
                    <span class="text-xs text-[hsl(var(--foreground))]"><?php echo e(auth()->user()->roles->first()->name ?? 'Sin rol'); ?></span>
                </div>
            </div>
            ...
            <nav class="flex-1 space-y-1">
                ...
                <a href="<?php echo e(route('admin.tasks.index')); ?>"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors <?php echo e(request()->routeIs('admin.tasks.*') ? 'bg-[hsl(var(--primary))] text-white' : 'text-[hsl(var(--muted-foreground))] hover:bg-[hsl(var(--secondary))] hover:text-[hsl(var(--foreground))]'); ?>">
                    ...
                    <span class="px-1.5 py-0.5 text-[10px] font-medium rounded-full bg-green-500/20 text-green-500"><?php echo e($pendingTasksCount); ?></span>
                    <?php endif; ?>
                </a>
                ...
                <a href="<?php echo e(route('admin.landing-config.show')); ?>" 
                   class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors <?php echo e(request()->routeIs('landing-config.*') ? 'bg-[hsl(var(--primary))] text-white' : 'text-[hsl(var(--muted-foreground))] hover:bg-[hsl(var(--secondary))] hover:text-[hsl(var(--foreground))]'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php if(auth()->user()->isColaborador()): ?>
            <div class="pb-4">
                <a href="<?php echo e(route('admin.leads.create')); ?>" class="w-full h-11 bg-[hsl(var(--primary))] hover:opacity-90 text-[#0a0f14] rounded-lg font-semibold text-sm transition-opacity flex items-center justify-center gap-2">
            ...
            <?php if(auth()->check() && session('impersonate_original_id')): ?>
                <a href="<?php echo e(route('impersonate.leave')); ?>" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm bg-yellow-500 text-white font-bold mb-2 hover:bg-yellow-600 transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
