...
">
                ...
                <a href="<?php echo e(route('admin.landing-template.select')); ?>"
                    class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors <?php echo e((request()->routeIs('admin.landing-template.*') || request()->routeIs('admin.landing-config.*')) ? 'bg-[hsl(var(--primary))] text-white' : 'text-[hsl(var(--muted-foreground))] hover:bg-[hsl(var(--secondary))] hover:text-[hsl(var(--foreground))]'); ?>">
