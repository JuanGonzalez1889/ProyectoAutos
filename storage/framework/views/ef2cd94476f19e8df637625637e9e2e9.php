...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="text-sm text-[hsl(var(--muted-foreground))]">
            Último mes: <?php echo e(now()->format('F Y')); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="card p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs font-medium px-2 py-1 rounded <?php echo e($leadsTrend >= 0 ? 'bg-green-500/20 text-green-500' : 'bg-red-500/20 text-red-500'); ?>">
                    <?php echo e($leadsTrend >= 0 ? '+' : ''); ?><?php echo e($leadsTrend); ?>%
                </span>
            </div>
            <h3 class="text-2xl font-bold text-white"><?php echo e($totalLeadsThisMonth); ?></h3>
        ...
        <div class="card p-6">
            ...
            <h3 class="text-2xl font-bold text-white"><?php echo e($conversionRate); ?>%</h3>
        ...
        <div class="card p-6">
            ...
            <h3 class="text-2xl font-bold text-white"><?php echo e($mostViewedVehicles->count()); ?></h3>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-[hsl(var(--border))]">
                    <?php $__empty_1 = true; $__currentLoopData = $mostViewedVehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-[hsl(var(--muted))] transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <?php if($vehicle->images && count($vehicle->images) > 0): ?>
                                        <img src="<?php echo e($vehicle->images[0]); ?>" alt="<?php echo e($vehicle->brand); ?> <?php echo e($vehicle->model); ?>" class="w-12 h-12 rounded object-cover mr-3">
                                    <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                    <div>
                                        <div class="text-sm font-medium text-white"><?php echo e($vehicle->brand); ?> <?php echo e($vehicle->model); ?></div>
                                        <div class="text-xs text-[hsl(var(--muted-foreground))]"><?php echo e($vehicle->year); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm text-white font-semibold">$ <?php echo e(number_format($vehicle->price, 0, ',', '.')); ?></span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm text-[hsl(var(--muted-foreground))]"><?php echo e($vehicle->created_at->diffForHumans()); ?></span>
                            </td>
                        </tr>
...
<script>
    ...
    const leadsData = <?php echo json_encode($leadsThisMonth, 15, 512) ?>;
    ...
    const trafficData = <?php echo json_encode($trafficSources, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\admin\analytics\index.blade.php ENDPATH**/ ?>