    ...
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="md:w-1/2 flex flex-col">
            ...
            <div class="flex gap-4 mb-2">
                <span class="text-black text-xs px-3 py-1 rounded" style="background: var(--tertiary-color);">Año: <?php echo e($vehicle->year); ?></span>
                <span class="text-black text-xs px-3 py-1 rounded" style="background: var(--tertiary-color);">Precio: $<?php echo e(number_format($vehicle->price)); ?></span>
            </div>
...
<?php echo $__env->make('public.templates.deportivo-base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\vehiculos\show-deportivo.blade.php ENDPATH**/ ?>