...
<div class="max-w-7xl mx-auto px-4 py-12" style="font-family: <?php echo e($settings->font_family ?? 'inherit'); ?>;">
    <h1 class="text-4xl font-bold mb-10 text-center" style="color: var(--primary-color)">Nuestra Colección</h1>
...
<?php echo $__env->make('public.templates.elegante-base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\vehiculos\index-elegante.blade.php ENDPATH**/ ?>