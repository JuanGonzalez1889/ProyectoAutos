...
<head>
    ...
    <title><?php echo e($tenant->name ?? 'Agencia de Autos'); ?> - Vehículos</title>
    ...
    <style>
        ...
        .autono-nav-link {
            color: <?php echo e($settings->navbar_links_color ?? $textOnSecondary); ?>;
            font-weight: 500;
    ...
    <header class="sticky top-0 z-50" style="background: var(--secondary-color); border-bottom: 1px solid var(--border-on-secondary);">
        <div class="max-w-[1600px] mx-auto px-7 md:px-14 py-8 flex items-center justify-between">
            <a href="/" class="flex items-center gap-3 no-underline">
                ...
                <?php endif; ?>
                <?php if($brandName !== ''): ?>
                    <span class="text-3xl tracking-[0.35em] font-bold" style="color: <?php echo e($settings->agency_name_color ?? $textOnSecondary); ?>"><?php echo e($brandName); ?></span>
                <?php endif; ?>
            </a>
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\templates\autono-base.blade.php ENDPATH**/ ?>