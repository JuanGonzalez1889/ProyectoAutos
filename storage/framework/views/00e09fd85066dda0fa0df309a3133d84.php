...
<div class="max-w-7xl mx-auto px-4 py-12" style="font-family: <?php echo e($settings->font_family ?? 'inherit'); ?>;">
    <h1 class="text-4xl font-bold mb-10 text-center" style="color: var(--primary-color)">Vehículos Disponibles</h1>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <?php $__empty_1 = true; $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="rounded-2xl shadow-xl overflow-hidden border flex flex-col vehiculo-card-bg">
                <div class="relative">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-span-full text-center py-16 vehiculo-card-auto">
...
<?php echo $__env->make('public.templates.tecnologico-base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\vehiculos\index-tecnologico.blade.php ENDPATH**/ ?>