        ...
        <div class="w-full flex flex-col md:flex-row gap-12 items-center justify-center mx-auto">
            ...
            <div class="text-center md:text-left w-full md:w-1/2 flex flex-col justify-center px-0 md:px-0">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    ...
                    <a href="<?php echo e(route('landing.demo-instructivos')); ?>" class="px-8 py-4 glass rounded-lg font-semibold text-white hover-glow inline-flex items-center justify-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section class="py-24 px-4">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
                    <form action="<?php echo e(route('landing.contact')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views/landing/home.blade.php ENDPATH**/ ?>