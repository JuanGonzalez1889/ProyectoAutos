...
<body style="background-color: var(--secondary-color); zoom: 1.25;" class="text-white">
    <?php if(isset($editMode) && $editMode): ?>
    <script>
        ...
        <div class="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center">
            ...
            <div class="flex items-center gap-6">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="px-6 py-2 rounded-full font-bold transition hover:scale-105" style="background-color: var(--primary-color); color: var(--secondary-color);">
                        PANEL ADMIN
                    </a>
                <?php endif; ?>
            </div>
    ...
    <div class="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <?php else: ?>
            <?php if($settings && $settings->banner_url): ?>
                <img src="<?php echo e($settings->banner_url); ?>" alt="Banner" class="absolute inset-0 w-full h-full object-cover blur-sm opacity-50">
            <?php endif; ?>
        <?php endif; ?>
...
<?php /**PATH C:\Users\Juan Gonzalez\Desktop\JuanMauro\ProyectoAutos\resources\views/public/templates/deportivo.blade.php ENDPATH**/ ?>