...
<body class="bg-gray-50">
    <?php echo $__env->make("public.templates.{$template}", [
        'settings' => $settings,
        'tenant' => $tenant,
        'vehicles' => [],
        'editMode' => true
    ...
    <script>
        ...
        function getFieldValue(field) {
            const values = {
                home_description: '<?php echo e(addslashes($settings->home_description ?? "")); ?>',
                ...
                contact_message: '<?php echo e(addslashes($settings->contact_message ?? "")); ?>',
                phone: '<?php echo e($settings->phone ?? ""); ?>',
                email: '<?php echo e($settings->email ?? ""); ?>',
                whatsapp: '<?php echo e($settings->whatsapp ?? ""); ?>',
                facebook_url: '<?php echo e($settings->facebook_url ?? ""); ?>',
                instagram_url: '<?php echo e($settings->instagram_url ?? ""); ?>',
                linkedin_url: '<?php echo e($settings->linkedin_url ?? ""); ?>',
                logo_url: '<?php echo e($settings->logo_url ?? ""); ?>',
                banner_url: '<?php echo e($settings->banner_url ?? ""); ?>',
                nosotros_image: 'https://images.unsplash.com/photo-1487730116645-74489c95b41b?w=600&h=500&fit=crop',
                primary_color: '<?php echo e($settings->primary_color ?? "#8b5cf6"); ?>',
                secondary_color: '<?php echo e($settings->secondary_color ?? "#1e293b"); ?>'
            };
            return values[field] || '';
        }
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\admin\landing-template\preview-editable.blade.php ENDPATH**/ ?>