...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="p-5 bg-gradient-to-br from-green-500/10 to-green-600/10 border border-green-500/20 rounded-lg">
            ...
            <p class="text-2xl font-bold text-white"><?php echo e(number_format($stats['total_agencias'] ?? 0)); ?></p>
        </div>
        ...
        <div class="p-5 bg-gradient-to-br from-purple-500/10 to-purple-600/10 border border-purple-500/20 rounded-lg">
            ...
            <p class="text-2xl font-bold text-white"><?php echo e(number_format($stats['units_sold'] ?? 0)); ?></p>
        </div>
        ...
        <div class="p-5 bg-gradient-to-br from-red-500/10 to-red-600/10 border border-red-500/20 rounded-lg">
            ...
            <p class="text-2xl font-bold text-white"><?php echo e(number_format($stats['pending_events'] ?? 0)); ?></p>
        </div>
    </div>
                ...
                <div class="flex items-center justify-center mb-6">
                    <div class="relative w-40 h-40">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <span class="text-3xl font-bold text-white">$<?php echo e(number_format($stats['sales_performance'] ?? 0)); ?></span>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>