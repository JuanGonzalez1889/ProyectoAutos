<footer class="border-t border-white/10 bg-[#020617]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <!-- Columna 1 - Brand -->
            <div>
                <div class="flex items-center gap-2 mb-4">
                    <img src="/storage/icono.png" alt="Icono AutoWeb Pro" class="w-8 h-8 md:w-10 md:h-10 object-contain" />
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="/#servicios" class="text-sm text-gray-400 hover:text-white">Servicios</a></li>
                    <li><a href="/login" class="text-sm text-gray-400 hover:text-white">Inventario y Stock</a></li>
                    <li><a href="/#servicios" class="text-sm text-gray-400 hover:text-white">Sitio Web en minutos</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="/nosotros" class="text-sm text-gray-400 hover:text-white">Sobre Nosotros</a></li>
                    <li><a href="/proximamente" class="text-sm text-gray-400 hover:text-white">Próximos proyectos</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="/legal/privacidad" class="text-sm text-gray-400 hover:text-white">Privacidad</a></li>
                    <li><a href="/legal/terminos" class="text-sm text-gray-400 hover:text-white">Términos de Servicio</a></li>
                    <li><a href="/legal/cookies" class="text-sm text-gray-400 hover:text-white">Cookies</a></li>
                    <li><a href="/legal/seguridad" class="text-sm text-gray-400 hover:text-white">Seguridad</a></li>
                </ul>
            </div>
        </div>
...
<?php /**PATH C:\Users\Juan Gonzalez\Desktop\JuanMauro\ProyectoAutos\resources\views/components/footer.blade.php ENDPATH**/ ?>