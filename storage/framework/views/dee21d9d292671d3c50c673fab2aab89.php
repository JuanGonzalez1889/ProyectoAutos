...
<?php $__env->startSection('title', 'Nuevo Lead'); ?>
...
<div class="p-6">
    ...
    <!-- Formulario -->
    <div class="max-w-4xl">
        <form action="<?php echo e(route('admin.leads.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="source" 
                            ...
                            <option value="web" <?php echo e(old('source') === 'web' ? 'selected' : ''); ?>>Sitio Web</option>
                            <option value="phone" <?php echo e(old('source') === 'phone' ? 'selected' : ''); ?>>Teléfono</option>
                            <option value="social_media" <?php echo e(old('source') === 'social_media' ? 'selected' : ''); ?>>Redes Sociales</option>
                            <option value="referral" <?php echo e(old('source') === 'referral' ? 'selected' : ''); ?>>Referido</option>
                            <option value="walk_in" <?php echo e(old('source') === 'walk_in' ? 'selected' : ''); ?>>Visita Directa</option>
                            <option value="other" <?php echo e(old('source') === 'other' ? 'selected' : ''); ?>>Otro</option>
                        </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="status" 
                                ...
                                required
                                class="w-full px-3 py-2 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))] focus:outline-none focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-transparent">
                            <option value="new" <?php echo e(old('status', 'new') === 'new' ? 'selected' : ''); ?>>Nuevo</option>
                            <option value="contacted" <?php echo e(old('status') === 'contacted' ? 'selected' : ''); ?>>Contactado</option>
                            <option value="interested" <?php echo e(old('status') === 'interested' ? 'selected' : ''); ?>>Interesado</option>
                            <option value="negotiating" <?php echo e(old('status') === 'negotiating' ? 'selected' : ''); ?>>Negociando</option>
                            <option value="won" <?php echo e(old('status') === 'won' ? 'selected' : ''); ?>>Ganado</option>
                            <option value="lost" <?php echo e(old('status') === 'lost' ? 'selected' : ''); ?>>Perdido</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="datetime-local" 
                               name="next_follow_up" 
                               id="next_follow_up"
                               value="<?php echo e(old('next_follow_up')); ?>"
                               class="w-full px-3 py-2 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-[hsl(var(--foreground))] focus:outline-none focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-transparent">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" 
                                  ...
                                  placeholder="Información adicional sobre el lead..."><?php echo e(old('notes')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views/leads/create.blade.php ENDPATH**/ ?>