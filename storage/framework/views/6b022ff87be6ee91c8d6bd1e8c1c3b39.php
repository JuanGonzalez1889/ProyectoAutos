        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            <?php $__empty_1 = true; $__currentLoopData = $vehicles->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <article class="vehicle-card">
                    <img src="<?php echo e($vehicle->main_image); ?>" alt="<?php echo e($vehicle->title); ?>" class="w-full h-52 object-cover">
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between gap-3">
                            ...
                            <button onclick="openContactForm(<?php echo e($vehicle->id); ?>, '<?php echo e(addslashes($vehicle->title)); ?>')" class="px-4 py-2 rounded-full text-sm" style="background: var(--primary-color); color: var(--text-on-primary);">Consultar</button>
                        </div>
                    </div>
                </article>
    ...
    <?php if(!isset($settings) || $settings->show_contact_form): ?>
        <section id="contacto" class="autono-section">
            <div class="max-w-4xl mx-auto">
                ...
                <form action="<?php echo e(route('public.contacto')); ?>" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views/public/templates/autono.blade.php ENDPATH**/ ?>