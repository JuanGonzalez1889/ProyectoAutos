...
<?php $__env->startSection('title', 'Planes de Suscripción'); ?>
<?php $__env->startSection('page-title', 'Planes de Suscripción'); ?>
...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <?php if($tenant && $tenant->isOnTrial()): ?>
    ...
    <div class="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-4 mb-6">
        <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm text-[hsl(var(--muted-foreground))] mt-1">
                    Plan actual: <strong class="text-emerald-400"><?php echo e(ucfirst($currentSubscription->plan)); ?></strong> 
                    • Próxima renovación: <?php echo e($currentSubscription->current_period_end->format('d/m/Y')); ?>

                </p>
            </div>
            <a href="<?php echo e(route('subscriptions.billing')); ?>" class="text-sm text-blue-400 hover:text-blue-300">
                Ver facturación →
            </a>
        </div>
    </div>
        ...
        <div class="card group hover:border-blue-500/50 transition-all duration-300">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <?php if($currentSubscription && $currentSubscription->plan === 'basic'): ?>
                ...
                <form action="<?php echo e(route('subscriptions.checkout')); ?>" method="POST" class="space-y-3">
                    <?php echo csrf_field(); ?>
        ...
        <div class="card group hover:border-blue-500/50 transition-all duration-300 relative border-blue-500/30 shadow-lg shadow-blue-500/10">
            ...
            <div class="p-6 pt-8">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <?php if($currentSubscription && $currentSubscription->plan === 'premium'): ?>
                        <span class="text-xs px-2 py-1 bg-blue-500/20 text-blue-400 rounded-full">Plan actual</span>
                    <?php endif; ?>
                </div>
        ...
        <div class="card group hover:border-blue-500/50 transition-all duration-300">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <?php if($currentSubscription && $currentSubscription->plan === 'enterprise'): ?>
                        <span class="text-xs px-2 py-1 bg-blue-500/20 text-blue-400 rounded-full">Plan actual</span>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\subscriptions\plans.blade.php ENDPATH**/ ?>