...
<?php $__env->startSection('title', 'Dashboard - Agenciero'); ?>
<?php $__env->startSection('page-title', 'Resumen General'); ?>

<?php $__env->startSection('content'); ?>
<div class="space-y-6">
    <?php if(isset($stats['agencia']) && $stats['agencia']->tenant && $stats['agencia']->tenant->settings && $stats['agencia']->tenant->settings->template): ?>
        <div class="mb-6">
            <div class="inline-block px-4 py-2 rounded-lg bg-gray-700 text-white text-base font-semibold shadow">
                ...
                <span class="px-2 py-1 rounded bg-[hsl(var(--primary))] text-[#0a0f14] font-bold"><?php echo e(ucfirst($stats['agencia']->tenant->settings->template)); ?></span>
            </div>
        </div>
    <?php endif; ?>
    <?php if(($onboarding['show'] ?? false)): ?>
    <style>
        .onboarding-backdrop {
            position: fixed;
            inset: 0;
    ...
    <div class="onboarding-backdrop">
        <div class="onboarding-modal">
            ...
            <form method="POST" action="<?php echo e(route('admin.onboarding.complete')); ?>" class="space-y-6" id="onboarding-form">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <span class="h-12 px-4 flex items-center bg-[hsl(var(--muted))] border border-[hsl(var(--border))] rounded-r-lg text-sm text-[hsl(var(--muted-foreground))] whitespace-nowrap font-medium">
                            <?php echo e($onboarding['domain_suffix'] ?? '.autowebpro.com.ar'); ?>
            ...
            <script>
                ...
                domainInput.addEventListener('input', function() {
                    ...
                    checkTimeout = setTimeout(() => {
                        fetch(`<?php echo e(route('admin.check-domain')); ?>?domain=${encodeURIComponent(domain)}`)
                            .then(res => res.json())
                            .then(data => {
                                domainLoader.classList.remove('active');
                                if (data.available) {
    ...
    <div class="flex items-center justify-between">
        <div>
            <p class="text-xs text-[hsl(var(--muted-foreground))]"><?php echo e(now()->locale('es')->isoFormat('dddd, D [de] MMMM YYYY')); ?></p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 card">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="text-right">
                    <p class="text-2xl font-bold text-[hsl(var(--primary))]">$<?php echo e(number_format($stats['sales_performance'], 0)); ?></p>
        ...
        <div class="space-y-6">
            ...
            <?php if(count($stats['top_vehicles']) > 0): ?>
                <?php $vehicle = $stats['top_vehicles']->first(); ?>
                <div class="card p-0 overflow-hidden relative">
                    ...
                    <div class="p-4">
                        <h3 class="font-semibold text-white mb-1"><?php echo e($vehicle->title); ?> <?php echo e($vehicle->year); ?></h3>
                        <p class="text-xs text-[hsl(var(--muted-foreground))] mb-2">Vistas: <?php echo e($vehicle->views ?? 0); ?></p>
                        <div class="flex items-center justify-between">
                            <p class="text-lg font-bold text-[hsl(var(--primary))]">$<?php echo e(number_format($vehicle->price, 0)); ?></p>
                            <a href="<?php echo e(route('admin.vehicles.show', $vehicle->id)); ?>" class="text-xs text-white hover:text-[hsl(var(--primary))] flex items-center gap-1">
            ...
            <?php else: ?>
                <div class="card p-0 overflow-hidden relative">
                    ...
                    <div class="p-4">
                        ...
                        <a href="<?php echo e(route('admin.vehicles.create')); ?>" class="text-xs text-[hsl(var(--primary))] hover:underline">
                            Crear Vehículo →
                        </a>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <a href="<?php echo e(route('admin.events.create')); ?>" class="w-full mt-4 pt-3 border-t border-[hsl(var(--border))] text-xs text-[hsl(var(--primary))] hover:text-[hsl(var(--primary))]/80 flex items-center justify-center gap-1">
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="card">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('admin.agencia.show')); ?>" class="text-sm text-[hsl(var(--primary))] hover:underline">
                Editar Agencia
            </a>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div>
                ...
                <p class="font-semibold text-white"><?php echo e($stats['agencia']->nombre); ?></p>
            </div>
            <div>
                <p class="text-[hsl(var(--muted-foreground))] mb-1">Ubicación</p>
                <p class="font-semibold text-white"><?php echo e($stats['agencia']->ubicacion ?: 'No especificada'); ?></p>
            </div>
            <div>
                <p class="text-[hsl(var(--muted-foreground))] mb-1">Teléfono</p>
                <p class="font-semibold text-white"><?php echo e($stats['agencia']->telefono ?: 'No especificado'); ?></p>
            </div>
        </div>
    </div>
</div>
