        ...
        <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="rounded-2xl shadow-2xl overflow-hidden border-2 flex flex-col vehiculo-card-bg">
                <div class="relative">
                    ...
                    <span class="absolute top-2 left-2 text-black text-xs px-3 py-1 rounded" style="background: var(--tertiary-color);"><?php echo e($vehicle->year); ?></span>
                    <span class="absolute top-2 right-2 text-black text-xs px-3 py-1 rounded" style="background: var(--tertiary-color);">$<?php echo e(number_format($vehicle->price)); ?></span>
                </div>
...
<?php echo $__env->make('public.templates.deportivo-base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\vehiculos\index-deportivo.blade.php ENDPATH**/ ?>