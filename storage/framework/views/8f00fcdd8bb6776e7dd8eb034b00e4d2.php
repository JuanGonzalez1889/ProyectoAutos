    ...
    <nav class="sticky top-0 z-50" style="background: var(--secondary-color); backdrop-filter: blur(20px); border-bottom: 1px solid var(--tertiary-color);">
        <div class="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between">
            <div class="flex items-center gap-2.5">
                <?php if(isset($editMode) && $editMode): ?>
                    ...
                    <div class="editable-section inline-block relative" style="min-width:100px; display:flex; align-items:center; gap:6px;">
                        <span class="text-lg font-bold text-gray-900" style="color: <?php echo e($settings->agency_name_color ?? '#111827'); ?>"><?php echo e($tenant->name); ?></span>
            ...
            <div class="hidden md:flex items-center gap-7">
                <a href="/" class="text-sm font-medium transition hover:text-gray-900" style="color: <?php echo e($settings->navbar_links_color ?? '#6b7280'); ?>">Inicio</a>
                <a href="<?php echo e(route('public.vehiculos')); ?>" class="text-sm font-medium transition hover:text-gray-900" style="color: <?php echo e($settings->navbar_links_color ?? '#6b7280'); ?>">Vehículos</a>
                <a href="/#nosotros" class="text-sm font-medium transition hover:text-gray-900" style="color: <?php echo e($settings->navbar_links_color ?? '#6b7280'); ?>">Nosotros</a>
                <a href="/#contacto" class="text-sm font-medium transition hover:text-gray-900" style="color: <?php echo e($settings->navbar_links_color ?? '#6b7280'); ?>">Contacto</a>
            </div>
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\templates\innovador-base.blade.php ENDPATH**/ ?>