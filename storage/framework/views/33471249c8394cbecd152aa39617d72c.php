        ...
        <div class="max-w-6xl mx-auto px-6 py-4 relative">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex items-center gap-6">
                    <a href="/" class="navbar-link-auto transition font-medium" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">Inicio</a>
                    <a href="<?php echo e(route('public.vehiculos')); ?>" class="navbar-link-auto transition font-medium" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">Vehículos</a>
                    <a href="/#nosotros" class="navbar-link-auto transition font-medium" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">Nosotros</a>
                    <a href="/#contacto" class="navbar-link-auto transition font-medium" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">Contacto</a>
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\templates\clasico-base.blade.php ENDPATH**/ ?>