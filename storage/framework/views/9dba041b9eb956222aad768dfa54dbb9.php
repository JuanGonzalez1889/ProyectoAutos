...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="card p-0 overflow-hidden group">
            ...
            <!-- Contenido -->
            <div class="p-4">
                <h3 class="font-semibold text-white mb-1 truncate"><?php echo e($vehicle->title); ?></h3>
                ...
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <?php if($vehicle->price_original && $vehicle->price_original > $vehicle->price): ?>
                            <p class="text-xs text-[hsl(var(--muted-foreground))] line-through">$<?php echo e(number_format($vehicle->price_original)); ?></p>
                        <?php endif; ?>
                        <p class="text-xl font-bold text-[hsl(var(--primary))]">$<?php echo e(number_format($vehicle->price)); ?></p>
                    </div>
                </div>
