...
<div class="max-w-4xl mx-auto px-4 py-12" style="font-family: <?php echo e($settings->font_family ?? 'inherit'); ?>;">
    <div class="flex flex-col md:flex-row gap-8">
        <div class="md:w-1/2">
            <img id="main-vehicle-image" src="<?php echo e($vehicle->main_image); ?>" alt="<?php echo e($vehicle->title); ?>" class="w-full h-80 object-cover rounded-xl mb-4">
...
<?php echo $__env->make('public.templates.minimalista-base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\vehiculos\show-minimalista.blade.php ENDPATH**/ ?>