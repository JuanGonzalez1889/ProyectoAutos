...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form action="<?php echo e(route('admin.users.permissions.update', $user)); ?>" method="POST" class="space-y-8">
            <?php echo csrf_field(); ?>
                ...
                <div class="space-y-3">
                    ...
                    <label class="flex items-center p-3 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition">
                        <input type="checkbox" 
                               ...
                               <?php if(in_array($role->name, $userRoles)): echo 'checked'; endif; ?>
                               class="w-4 h-4 text-blue-600 rounded focus:ring-2 focus:ring-blue-500">
                        <span class="ml-3 flex-1">
                            <span class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($role->name); ?></span>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                Acceso: <?php echo e(match($role->name) {
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <h3 class="text-base font-semibold text-gray-900 dark:text-white mb-4 capitalize">
                        <?php echo e($module === 'audit' ? 'Auditoría' : 
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        ...
                        <label class="flex items-center p-2 border border-gray-200 dark:border-gray-700 rounded hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition">
                            <input type="checkbox" 
                                   ...
                                   <?php if(in_array($permission->name, $userPermissions)): echo 'checked'; endif; ?>
                                   class="w-4 h-4 text-blue-600 rounded focus:ring-2 focus:ring-blue-500">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\admin\users\permissions.blade.php ENDPATH**/ ?>