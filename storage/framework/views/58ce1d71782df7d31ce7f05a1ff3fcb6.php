...
<body style="background-color: var(--secondary-color);" class="text-white">
    ...
    <nav class="bg-gray-800 border-b border-gray-700 sticky top-0 z-50">
        <div class="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
            <div class="flex items-center gap-3">
                <?php if(isset($editMode) && $editMode): ?>
                    ...
                    <div class="editable-section inline-block relative ml-2">
                        <span class="font-semibold navbar-auto"><?php echo e($settings->navbar_agency_name); ?></span>
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="hidden md:flex gap-6">
                    <a href="/" class="text-sm navbar-link-auto transition" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">Inicio</a>
                    <a href="<?php echo e(route('public.vehiculos')); ?>" class="text-sm navbar-link-auto transition" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">Vehículos</a>
                    <a href="/#nosotros" class="text-sm navbar-link-auto transition" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">Nosotros</a>
                    <a href="/#contacto" class="text-sm navbar-link-auto transition" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">Contacto</a>
                </div>
        ...
        <div id="mobile-menu" class="md:hidden fixed inset-0 bg-gray-900 bg-opacity-95 z-50 flex flex-col items-center justify-center space-y-8 text-lg font-semibold transition-all duration-300 opacity-0 pointer-events-none">
            ...
            <a href="/" class="navbar-link-auto" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">Inicio</a>
            <a href="<?php echo e(route('public.vehiculos')); ?>" class="navbar-link-auto" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">Vehículos</a>
            <a href="/#nosotros" class="navbar-link-auto" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">Nosotros</a>
            <a href="/#contacto" class="navbar-link-auto" style="color: <?php echo e($settings->navbar_links_color ?? 'var(--navbar-text-color, #fff)'); ?>">Contacto</a>
        </div>
        </div>
    </nav>
    ...
    <section class="max-w-7xl mx-auto px-4 py-12">
        <div class="rounded-3xl bg-gradient-to-b from-gray-700 to-gray-900 shadow-xl overflow-hidden relative flex flex-col justify-center items-center min-h-[320px]">
            <?php if(isset($editMode) && $editMode): ?>
                <form action="<?php echo e(route('admin.template.hero.update', $tenant->id)); ?>" method="POST" enctype="multipart/form-data" class="absolute top-4 left-4 z-10">
                    <?php echo csrf_field(); ?>
                    <input type="text" name="hero_title" value="<?php echo e($settings->hero_title ?? 'Curando el futuro de la movilidad'); ?>" class="bg-gray-800 text-white rounded px-4 py-2 mb-2 w-96 font-bold text-2xl" placeholder="Título principal">
            ...
            <div class="flex flex-col items-center justify-center h-full w-full">
                <?php if($settings && $settings->hero_image): ?>
                    <img src="<?php echo e($settings->hero_image); ?>" alt="Hero" class="mx-auto mb-6 rounded-xl object-cover h-48 w-full max-w-lg">
                <?php else: ?>
                ...
                <?php endif; ?>
                <div class="px-6 py-4">
                    <h1 class="text-4xl font-extrabold mb-2 text-center" style="background: linear-gradient(90deg, var(--primary-color), #5a7cff); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><?php echo e($settings->hero_title ?? 'Curando el futuro de la movilidad'); ?></h1>
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\templates\minimalista-base.blade.php ENDPATH**/ ?>