        ...
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            <div class="flex items-center gap-6">
                <?php if($settings->phone): ?>
                    <a href="tel:<?php echo e($settings->phone); ?>" class="flex items-center gap-1.5 hover:text-white transition" style="color: rgba(255,255,255,0.85);">
                ...
                <?php if($settings->email): ?>
                    <a href="mailto:<?php echo e($settings->email); ?>" class="flex items-center gap-1.5 hover:text-white transition" style="color: rgba(255,255,255,0.85);">
            ...
            <div class="flex items-center gap-4">
                <?php if($settings->instagram_url): ?><a href="<?php echo e($settings->instagram_url); ?>" target="_blank" class="hover:text-white transition" style="color: rgba(255,255,255,0.85);">Instagram</a><?php endif; ?>
                <?php if($settings->facebook_url): ?><a href="<?php echo e($settings->facebook_url); ?>" target="_blank" class="hover:text-white transition" style="color: rgba(255,255,255,0.85);">Facebook</a><?php endif; ?>
                <?php if($settings->linkedin_url): ?><a href="<?php echo e($settings->linkedin_url); ?>" target="_blank" class="hover:text-white transition" style="color: rgba(255,255,255,0.85);">LinkedIn</a><?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <nav class="sticky top-0 z-50" style="background: var(--secondary-color); box-shadow: 0 2px 8px rgba(0,0,0,0.04); border-bottom: 1px solid var(--tertiary-color);">
        <div class="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between relative">
            ...
            <div class="hidden md:flex items-center gap-8">
                <a href="/" class="text-sm font-medium text-gray-500 hover:text-gray-900 transition" style="color: <?php echo e($settings->navbar_links_color ?? '#64748b'); ?>">Inicio</a>
...
<?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\templates\corporativo-base.blade.php ENDPATH**/ ?>