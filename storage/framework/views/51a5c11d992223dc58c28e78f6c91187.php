    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full bg-white text-gray-900 rounded shadow text-xs">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="border px-2 py-1"><?php echo e($inv->id); ?></td>
                            <td class="border px-2 py-1"><?php echo e($inv->tenant->name ?? '-'); ?></td>
                            <td class="border px-2 py-1"><?php echo e($inv->subscription_id); ?></td>
                            <td class="border px-2 py-1">$<?php echo e(number_format($inv->total, 2)); ?></td>
                            <td class="border px-2 py-1"><?php echo e($inv->status); ?></td>
                            <td class="border px-2 py-1"><?php echo e($inv->paid_at ? $inv->paid_at->format('Y-m-d') : '-'); ?></td>
                            <td class="border px-2 py-1"><?php echo e($inv->due_date ? $inv->due_date->format('Y-m-d') : '-'); ?></td>
                            <td class="border px-2 py-1 text-center">
                                <a href="<?php echo e(route('invoices.download', $inv->id)); ?>" class="text-xs text-blue-600 hover:underline" target="_blank">PDF</a>
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
            ...
            <div class="mb-10">
                <div class="flex flex-col md:flex-row items-center justify-between bg-[#181f2a] border border-[#2c374a] rounded-xl px-8 py-6 mb-6">
                    <div>
                        ...
                        <div class="text-3xl font-extrabold text-[#3fffc2]"><?php echo e($currentPlanName); ?></div>
                    </div>
                    <a href="<?php echo e(route('subscriptions.billing')); ?>" class="mt-4 md:mt-0 px-8 py-3 bg-[#3fffc2] hover:bg-[#2be6a7] text-[#23272f] font-semibold rounded-lg text-lg transition">Gestionar Suscripción</a>
                </div>
            </div>
        <?php endif; ?>
        <!-- Plans Comparison -->
        <div id="plans" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-[hsl(var(--card))] border-2 border-[hsl(var(--border))] rounded-lg p-6 relative flex flex-col h-full">
                ...
                <div class="mt-auto">
                    <?php if(($currentPlan['plan'] ?? null) === 'basico'): ?>
            ...
            <div class="bg-[hsl(var(--card))] border-2 border-[hsl(var(--primary))] rounded-lg p-6 relative shadow-lg flex flex-col h-full">
                ...
                <div class="mt-auto">
                    <?php if(($currentPlan['plan'] ?? null) === 'profesional'): ?>
                        <button disabled class="w-full py-2 bg-gray-400 text-white rounded-lg font-semibold cursor-not-allowed">
                            PLAN ACTUAL
                        </button>
                    <?php else: ?>
            ...
            <div class="bg-[hsl(var(--card))] border-2 border-[hsl(var(--border))] rounded-lg p-6 flex flex-col h-full">
                ...
                <div class="mt-auto">
                    <?php if(($currentPlan['plan'] ?? null) === 'premium'): ?>
                        <button disabled class="w-full py-2 bg-gray-400 text-white rounded-lg font-semibold cursor-not-allowed">
                            PLAN ACTUAL
                        </button>
                    <?php else: ?>
            ...
            <div class="bg-[hsl(var(--card))] border-2 border-[hsl(var(--border))] rounded-lg p-6 flex flex-col h-full">
                ...
                <div class="mt-auto">
                    <?php if(($currentPlan['plan'] ?? null) === 'premium_plus'): ?>
                        <button disabled class="w-full py-2 bg-gray-400 text-white rounded-lg font-semibold cursor-not-allowed">
                            PLAN ACTUAL
                        </button>
                    <?php else: ?>
