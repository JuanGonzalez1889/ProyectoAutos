...
<?php $__env->startSection('title', 'Invitar Colaborador'); ?>
<?php $__env->startSection('page-title', 'Invitar Colaborador'); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-lg shadow-lg p-8">
        ...
        <form action="<?php echo e(route('admin.invitations.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <select 
                    ...
                    <option value="collaborator" <?php echo e(old('role') === 'collaborator' ? 'selected' : ''); ?>>
            ...
            <div class="flex gap-3 pt-4 border-t border-[hsl(var(--border))]">
                ...
                <a 
                    href="<?php echo e(route('admin.invitations.index')); ?>" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\invitations\create.blade.php ENDPATH**/ ?>