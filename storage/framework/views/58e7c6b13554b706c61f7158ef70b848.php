    ...
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="md:w-1/2 flex flex-col">
            ...
            <form action="/contacto" method="POST" class="mb-4">
                ...
                <input type="email" name="email" placeholder="Tu Email" required class="w-full px-4 py-2 mb-2 rounded vehiculo-card-auto" style="background: var(--secondary-color); border: 1px solid #e5e7eb;">
                <input type="tel" name="phone" placeholder="Tu Teléfono" required class="w-full px-4 py-2 mb-2 rounded vehiculo-card-auto" style="background: var(--secondary-color); border: 1px solid #e5e7eb;">
                <textarea name="message" placeholder="Mensaje" rows="3" required class="w-full px-4 py-2 mb-2 rounded vehiculo-card-auto" style="background: var(--secondary-color); border: 1px solid #e5e7eb;"></textarea>
                <button type="submit" class="w-full py-2 rounded font-semibold" style="background: var(--primary-color); color: #fff;">Consultar</button>
            </form>
...
<?php echo $__env->make('public.templates.corporativo-base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\ProyectoAutos\resources\views\public\vehiculos\show-corporativo.blade.php ENDPATH**/ ?>